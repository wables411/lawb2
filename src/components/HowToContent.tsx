    ...
    <div className={`how-to-section ${variant === 'mobile' ? 'mobile' : ''}`}>
      ...
      <div className="how-to-content">
        ...
        <ol style={{ margin: '5px 0', paddingLeft: '20px', fontSize: '12px' }}>
          <li>Connect your wallet to Sanko or Base</li>
          <li>Create a match and set your wager</li>
          <li>Wait for an opponent to match wager and join match</li>
          <li>Match begins automatically - Blue (Player 1) moves first</li>
          <li>Winner claims the pot minus 5% house fee</li>
        </ol>
        <p><strong>Leaderboard:</strong> Chess points use your connected wallet (win = 3, draw = 1, loss = 0). The first time you connect with WalletConnect / Reown (EVM or Solana), you receive {WALLET_CONNECT_LEADERBOARD_BONUS} bonus points toward the same leaderboard total. Holdings points weight NFT tiers (Lawbsters/Lawbstarz highest; Lawb Lore lowest) and add a capped Base $LAWB + $CLAWB bonus when you refresh your Lawb Profile inventory.</p>
