      ...
      <MobilePopup98 isOpen={open} onClose={onClose} title="tokens">
        ...
        {tab === 'faq' && (
          <>
            ...
            <p style={{marginBottom: '10px'}}><strong>$CULT</strong> (Milady Cult Coin, Ethereum) — Remilia&apos;s token, the featured wager token for on-chain Lawb Chess on Ethereum. CA: 0x0000000000c5dc95539589fbD24BE07c6C14eCa4</p>
