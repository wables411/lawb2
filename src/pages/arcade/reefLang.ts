...
const en = {
  ...
  jpBarStale: 'BAR UNBEATEN 7+ DAYS — IT CAN BE OPENED, AND THE CHEST GOES TO THE NEXT DIVE THAT BEATS ZERO',
  jpBarStaleBtn: 'OPEN THE BAR',
  jpBarStaleBusy: 'OPENING THE BAR…',
  jpBarStaleDone: 'BAR OPEN — ANY VERIFIED RUN NOW TAKES THE CHEST',
...
const zh: ReefStrings = {
  ...
  jpBarStale: '纪录已 7 天以上无人打破——现可重置为空缺，宝箱将归下一位有效成绩的潜水者',
  jpBarStaleBtn: '重置纪录',
  jpBarStaleBusy: '正在重置纪录……',
  jpBarStaleDone: '纪录已空缺——任何已验证的成绩即可夺宝',
  jpUnsubmitted: '未提交成绩：',
