import{Y as e,a1 as t,am as r,aE as i,aj as o,a8 as n,a2 as s,az as a,ad as c,a0 as u,$ as l,J as d,ab as p,R as m,L as h,H as y,I as g,W as w,F as f,ac as b,S as v}from"./index-BUdIrOsm.js";import{O as x}from"./react-cWtc6xGy.js";import"./wagmi-vendor-i7e2bp5A.js";import"./react-vendor-BlDtUSDV.js";import"./chess-vendor-BKDUb1NN.js";import"./ui-vendor-BJIjw2Nx.js";import"./index-YnnLfOoC.js";import"./index-CFYEtFbK.js";import"./WalletConnectConnector-vuTnuD4W.js";const $=e`
  :host > wui-grid {
    max-height: 360px;
    overflow: auto;
  }
...
`;var W=function(e,t,r,i){var o,n=arguments.length,s=n<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,r):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,r,i);else for(var a=e.length-1;a>=0;a--)(o=e[a])&&(s=(n<3?o(s):n>3?o(t,r,s):o(t,r))||s);return n>3&&s&&Object.defineProperty(t,r,s),s};const N={USD:"$",EUR:"€",GBP:"£"},F=[100,250,500,1e3];let M=class extends t{constructor(){super(),this.unsubscribe=[],this.disabled=!1,this.caipAddress=d.state.activeCaipAddress,this.loading=a.state.loading,this.paymentCurrency=x.state.paymentCurrency,this.paymentAmount=x.state.paymentAmount,this.purchaseAmount=x.state.purchaseAmount,this.quoteLoading=x.state.quotesLoading,this.unsubscribe.push(d.subscribeKey("activeCaipAddress",e=>this.caipAddress=e),a.subscribeKey("loading",e=>{this.loading=e}),x.subscribe(e=>{this.paymentCurrency=e.paymentCurrency,this.paymentAmount=e.paymentAmount,this.purchaseAmount=e.purchaseAmount,this.quoteLoading=e.quotesLoading}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return s`
      <wui-flex flexDirection="column" justifyContent="center" alignItems="center">
        <wui-flex flexDirection="column" alignItems="center" gap="2">
          ...
          <wui-flex justifyContent="space-evenly" class="amounts-container" gap="2">
            ${F.map(e=>{var t;return s`<wui-button
    ...
    `}templateButton(){return this.caipAddress?s`<wui-button
        ...
        >
          Connect wallet
        </wui-button>`}getQuotes(){this.loading||a.open({view:"OnRampProviders"})}openModal(){a.open({view:"Connect"})}async onPaymentAmountChange(e){x.setPaymentAmount(Number(e.detail)),await x.getQuote()}async selectPresetAmount(e){x.setPaymentAmount(e),await x.getQuote()}};M.styles=q,W([l({type:Boolean})],M.prototype,"disabled",void 0),W([c()],M.prototype,"caipAddress",void 0),W([c()],M.prototype,"loading",void 0),W([c()],M.prototype,"paymentCurrency",void 0),W([c()],M.prototype,"paymentAmount",void 0),W([c()],M.prototype,"purchaseAmount",void 0),W([c()],M.prototype,"quoteLoading",void 0),M=W([u("w3m-onramp-widget")],M);export{z as W3mBuyInProgressView,O as W3mOnRampProvidersView,C as W3mOnrampFiatSelectView,D as W3mOnrampTokensView,M as W3mOnrampWidget,S as W3mWhatIsABuyView};
