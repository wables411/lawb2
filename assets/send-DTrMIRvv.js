import{ba as f,bb as w,bm as I,bn as x,bu as H,bD as l,bd as u,bi as z,bs as W,br as g,bC as L,bE as q,bq as B,bo as F,bl as M,bp as Y}from"./index-CEhvpO5H.js";import{n as d,r as c,c as m,U as b,o as K}from"./if-defined-DnqqGul4.js";import"./index-CDT6TZPd.js";import"./index-C7n6MmmY.js";import{e as O,n as D}from"./ref-CorrK4Ok.js";import{n as G,s as J}from"./ConstantsUtil-Dmg8YACJ.js";import"./index-DcE-wB-4.js";import{S as Q}from"./index-BgPc2cXU.js";import"./index-DiBoySQP.js";import"./index-QT3dY7Pe.js";import"./index-l5jCOvam.js";import"./index-DBPGxzWp.js";import"./index-CTbfiYgY.js";const X=f`
  :host {
    width: 100%;
    height: 100px;
...
`;var E=function(s,e,i,n){var r=arguments.length,t=r<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,i):n,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(s,e,i,n);else for(var a=s.length-1;a>=0;a--)(o=s[a])&&(t=(r<3?o(t):r>3?o(e,i,t):o(e,i))||t);return r>3&&t&&Object.defineProperty(e,i,t),t};let C=class extends w{constructor(){super(...arguments),this.inputElementRef=O(),this.instructionElementRef=O(),this.instructionHidden=!!this.value,this.pasting=!1,this.onDebouncedSearch=I.debounce(async e=>{if(!e.length){this.setReceiverAddress("");return}const i=x.state.activeChain;if(I.isAddress(e,i)){this.setReceiverAddress(e);return}try{const r=await H.getEnsAddress(e);if(r){l.setReceiverProfileName(e),l.setReceiverAddress(r);const t=await H.getEnsAvatar(e);l.setReceiverProfileImageUrl(t||void 0)}}catch{this.setReceiverAddress(e)}finally{l.setLoading(!1)}})}firstUpdated(){this.value&&(this.instructionHidden=!0),this.checkHidden()}render(){return u` <wui-flex
...
`;var j=function(s,e,i,n){var r=arguments.length,t=r<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,i):n,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(s,e,i,n);else for(var a=s.length-1;a>=0;a--)(o=s[a])&&(t=(r<3?o(t):r>3?o(e,i,t):o(e,i))||t);return r>3&&t&&Object.defineProperty(e,i,t),t};let A=class extends w{constructor(){super(...arguments),this.inputElementRef=O(),this.disabled=!1,this.value="",this.placeholder="0"}render(){var e;return(e=this.inputElementRef)!=null&&e.value&&this.value&&(this.inputElementRef.value.value=this.value),u`<input
      ${D(this.inputElementRef)}
      type="text"
      inputmode="decimal"
      pattern="[0-9,.]*"
