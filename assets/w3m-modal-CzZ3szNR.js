import{c as e,r as t,a as o,i,x as r,n as a,o as n,g as s,e as l,v as c,C as d,f as p,H as u,U as h,k as m}from"./react-Brplheuo.js";import{M as g,n as w,R as b,C as f,A as y,a as v,j as k,u as x,E as $,O as C,h as S,S as R,I as P,T as I}from"./W3MFrameProviderSingleton-EqOK3Yp_.js";import"./index-Cp8rK9-X.js";import{S as O}from"./SwapController-BPRCM43m.js";import"./react-vendor-BlDtUSDV.js";import"./NetworkUtil-8PBlJxlj.js";import"./wagmi-vendor-CZVdyBCS.js";import"./index-CFYEtFbK.js";const W={isUnsupportedChainView:()=>"UnsupportedChain"===b.state.view||"SwitchNetwork"===b.state.view&&b.state.history.includes("UnsupportedChain"),async safeClose(){if(this.isUnsupportedChainView())return void g.shake();await w.isSIWXCloseDisabled()?g.shake():("DataCapture"!==b.state.view&&"DataCaptureOtpConfirm"!==b.state.view||f.disconnect(),g.close())}},E=e`
  :host {
    display: block;
