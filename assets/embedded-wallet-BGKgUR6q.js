import{a7 as e,a1 as t,az as i,aj as o,a2 as r,U as n,ac as s,aH as a,ad as d,a0 as c,Y as l,Z as u,_ as p,$ as h,Q as m,a8 as g,a3 as f,J as b,L as w,aI as y,a5 as v,G as x,H as $,I as k,W as S,S as R,aJ as E,R as A}from"./index-DYHDHHTo.js";import{E as C}from"./WalletConnectConnector-CwgdphhZ.js";import"./wagmi-vendor-cal8GwT5.js";import"./react-vendor-BlDtUSDV.js";import"./chess-vendor-BKDUb1NN.js";import"./ui-vendor-BJIjw2Nx.js";const T=e`
  div {
    width: 100%;
  }
...
`;var j=function(e,t,i,o){var r,n=arguments.length,s=n<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,o);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(n<3?r(s):n>3?r(t,i,s):r(t,i))||s);return n>3&&s&&Object.defineProperty(t,i,s),s};const z={sm:"md-regular",md:"lg-regular",lg:"lg-regular"},D={success:"sealCheck",error:"warning",warning:"exclamationCircle"};let P=class extends t{constructor(){super(...arguments),this.type="success",this.size="md",this.imageSrc=void 0,this.disabled=!1,this.href="",this.text=void 0}render(){return r`
      <a
        rel="noreferrer"
        target="_blank"
        href=${this.href}
    ...
    `}imageTemplate(){return this.imageSrc?r`<wui-image src=${this.imageSrc} size="inherit"></wui-image>`:r`<wui-icon
      ...
      size="inherit"
      class="image-icon"
    ></wui-icon>`}};P.styles=[u,p,I],j([h()],P.prototype,"type",void 0),j([h()],P.prototype,"size",void 0),j([h()],P.prototype,"imageSrc",void 0),j([h({type:Boolean})],P.prototype,"disabled",void 0),j([h()],P.prototype,"href",void 0),j([h()],P.prototype,"text",void 0),P=j([c("wui-semantic-chip")],P);let _=class extends t{render(){return r`
