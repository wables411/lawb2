import{i as T,a as w,x as c,D as J,F as l,G as N,H as x,A as S,O as j,M as I,e as O,t as Z,f as G,W as H,R as B,d as V,b as M,B as Q,k as ee,S as L,T as te}from"./index-D9FV4b5H.js";import{n as d,c as g,o as h,r as u}from"./if-defined-dtQgSYua.js";import{D as ie,T as re}from"./index-CZnyiw07.js";import"./index-BZyLb232.js";import"./index-CYANNYYk.js";import"./index-BaUC18Uv.js";import"./index-DEXSQU5o.js";import{O as z}from"./index-FMQVOaye.js";import"./index-CrB7-tDb.js";import"./index-OE98exTR.js";import"./index-BICK0SMf.js";import"./index-BkCMSRG9.js";import"./index-YOL5g8Y0.js";import"./index-B-RwqRDq.js";import"./ref-BNp2iLcT.js";import"./ConstantsUtil-Dmg8YACJ.js";const oe=T`
  :host {
    width: 100%;
  }
...
`;var ue=function(a,e,t,r){var o=arguments.length,i=o<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,r);else for(var n=a.length-1;n>=0;n--)(s=a[n])&&(i=(o<3?s(i):o>3?s(e,t,i):s(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i};let K=class extends w{render(){const{termsConditionsUrl:e,privacyPolicyUrl:t}=j.state;return!e&&!t?null:c`
    ...
    `}howDoesItWorkTemplate(){return c` <wui-link @click=${this.onWhatIsBuy.bind(this)}>
      ...
      How does it work?
    </wui-link>`}onWhatIsBuy(){var t;const e=O.state.activeChain;G.sendEvent({type:"track",event:"SELECT_WHAT_IS_A_BUY",properties:{isSmartAccount:((t=S.state.preferredAccountTypes)==null?void 0:t[e])===H.ACCOUNT_TYPES.SMART_ACCOUNT}}),B.push("WhatIsABuy")}};K.styles=[le];K=ue([g("w3m-onramp-providers-footer")],K);var X=function(a,e,t,r){var o=arguments.length,i=o<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,r);else for(var n=a.length-1;n>=0;n--)(s=a[n])&&(i=(o<3?s(i):o>3?s(e,t,i):s(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i};let Y=class extends w{constructor(){super(),this.unsubscribe=[],this.providers=l.state.providers,this.unsubscribe.push(l.subscribeKey("providers",e=>{this.providers=e}))}firstUpdated(){const e=this.providers.map(async t=>t.name==="coinbase"?await this.getCoinbaseOnRampURL():Promise.resolve(t==null?void 0:t.url));Promise.all(e).then(t=>{this.providers=this.providers.map((r,o)=>({...r,url:t[o]||""}))})}render(){return c`
      <wui-flex flexDirection="column" .padding=${["0","s","s","s"]} gap="xs">
