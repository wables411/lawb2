import{c as e,i as t,aa as r,ab as i,a2 as o,Q as n,L as s,x as a,Z as c,M as u,b as l,n as d,l as p,K as m,R as h,o as y,E as g,k as w,W as b,C as f,T as v,S as x}from"./index-ChflEmzT.js";import"./wagmi-vendor-CHW5eFys.js";import"./react-vendor-ZyuiJZO_.js";import"./chess-vendor-JTxzwGi1.js";import"./ui-vendor-BgPmeekb.js";const $=e`
  :host > wui-grid {
    max-height: 360px;
    overflow: auto;
  }
...
`;var N=function(e,t,r,i){var o,n=arguments.length,s=n<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,r):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,r,i);else for(var a=e.length-1;a>=0;a--)(o=e[a])&&(s=(n<3?o(s):n>3?o(t,r,s):o(t,r))||s);return n>3&&s&&Object.defineProperty(t,r,s),s};const W={USD:"$",EUR:"€",GBP:"£"},M=[100,250,500,1e3];let Q=class extends t{constructor(){super(),this.unsubscribe=[],this.disabled=!1,this.caipAddress=p.state.activeCaipAddress,this.loading=c.state.loading,this.paymentCurrency=r.state.paymentCurrency,this.paymentAmount=r.state.paymentAmount,this.purchaseAmount=r.state.purchaseAmount,this.quoteLoading=r.state.quotesLoading,this.unsubscribe.push(p.subscribeKey("activeCaipAddress",e=>this.caipAddress=e),c.subscribeKey("loading",e=>{this.loading=e}),r.subscribe(e=>{this.paymentCurrency=e.paymentCurrency,this.paymentAmount=e.paymentAmount,this.purchaseAmount=e.purchaseAmount,this.quoteLoading=e.quotesLoading}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return a`
    ...
    `}templateButton(){return this.caipAddress?a`<wui-button
        ...
        >
          Connect wallet
        </wui-button>`}getQuotes(){this.loading||c.open({view:"OnRampProviders"})}openModal(){c.open({view:"Connect"})}async onPaymentAmountChange(e){r.setPaymentAmount(Number(e.detail)),await r.getQuote()}async selectPresetAmount(e){r.setPaymentAmount(e),await r.getQuote()}};Q.styles=q,N([d({type:Boolean})],Q.prototype,"disabled",void 0),N([u()],Q.prototype,"caipAddress",void 0),N([u()],Q.prototype,"loading",void 0),N([u()],Q.prototype,"paymentCurrency",void 0),N([u()],Q.prototype,"paymentAmount",void 0),N([u()],Q.prototype,"purchaseAmount",void 0),N([u()],Q.prototype,"quoteLoading",void 0),Q=N([l("w3m-onramp-widget")],Q);export{S as W3mBuyInProgressView,j as W3mOnRampProvidersView,C as W3mOnrampFiatSelectView,D as W3mOnrampTokensView,Q as W3mOnrampWidget,U as W3mWhatIsABuyView};
