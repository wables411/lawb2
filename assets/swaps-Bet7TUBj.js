import{c as e,g as t,n as o,a as i,i as n,x as r,r as s,e as a,M as l}from"./react-B_KiSx6v.js";import{a as u,N as c,e as d,E as p,R as h,b as g,M as w,g as m,W as k}from"./W3MFrameProviderSingleton-CqxSc5tp.js";import{S as b}from"./SwapController-C9Nt7RMg.js";import"./index-BcbdlseP.js";import"./react-vendor-BlDtUSDV.js";import"./NetworkUtil-8PBlJxlj.js";import"./wagmi-vendor-CiBmrtm3.js";import"./index-CFYEtFbK.js";const f={numericInputKeyDown(e,t,o){const i=e.metaKey||e.ctrlKey,n=e.key,r=n.toLocaleLowerCase(),s=","===n,a="."===n,l=n>="0"&&n<="9";!i&&("a"===r||"c"===r||"v"===r||"x"===r)&&e.preventDefault(),"0"!==t||s||a||"0"!==n||e.preventDefault(),"0"===t&&l&&(o(n),e.preventDefault()),(s||a)&&(t||(o("0."),e.preventDefault()),((null==t?void 0:t.includes("."))||(null==t?void 0:t.includes(",")))&&e.preventDefault()),l||["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"].includes(n)||a||s||e.preventDefault()}},x=e`
  :host {
    width: 100%;
  }
...
`;var A=function(e,t,o,i){var n,r=arguments.length,s=r<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,o,i);else for(var a=e.length-1;a>=0;a--)(n=e[a])&&(s=(r<3?n(s):r>3?n(t,o,s):n(t,o))||s);return r>3&&s&&Object.defineProperty(t,o,s),s};let D=class extends n{constructor(){super(...arguments),this.focused=!1,this.price=0,this.target="sourceToken",this.onSetAmount=null,this.onSetMaxValue=null}render(){const e=this.marketValue||"0",t=c.bigNumber(e).gt("0");return r`
    ...
    `:r` <wui-button
      ...
      >
        Select token
      </wui-button>`}tokenBalanceTemplate(){const e=c.multiply(this.balance,this.price),t=!!e&&(null==e?void 0:e.gt(5e-5));return r`
...
`;var L=function(e,t,o,i){var n,r=arguments.length,s=r<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,o,i);else for(var a=e.length-1;a>=0;a--)(n=e[a])&&(s=(r<3?n(s):r>3?n(t,o,s):n(t,o))||s);return r>3&&s&&Object.defineProperty(t,o,s),s};let U=class extends n{constructor(){var e;super(),this.unsubscribe=[],this.detailsOpen=!0,this.approvalTransaction=b.state.approvalTransaction,this.swapTransaction=b.state.swapTransaction,this.sourceToken=b.state.sourceToken,this.sourceTokenAmount=b.state.sourceTokenAmount??"",this.sourceTokenPriceInUSD=b.state.sourceTokenPriceInUSD,this.balanceSymbol=null==(e=u.getAccountData())?void 0:e.balanceSymbol,this.toToken=b.state.toToken,this.toTokenAmount=b.state.toTokenAmount??"",this.toTokenPriceInUSD=b.state.toTokenPriceInUSD,this.caipNetwork=u.state.activeCaipNetwork,this.inputError=b.state.inputError,this.loadingQuote=b.state.loadingQuote,this.loadingApprovalTransaction=b.state.loadingApprovalTransaction,this.loadingBuildTransaction=b.state.loadingBuildTransaction,this.loadingTransaction=b.state.loadingTransaction,this.unsubscribe.push(u.subscribeChainProp("accountState",e=>{(null==e?void 0:e.balanceSymbol)!==this.balanceSymbol&&h.goBack()}),u.subscribeKey("activeCaipNetwork",e=>{this.caipNetwork!==e&&(this.caipNetwork=e)}),b.subscribe(e=>{this.approvalTransaction=e.approvalTransaction,this.swapTransaction=e.swapTransaction,this.sourceToken=e.sourceToken,this.toToken=e.toToken,this.toTokenPriceInUSD=e.toTokenPriceInUSD,this.sourceTokenAmount=e.sourceTokenAmount??"",this.toTokenAmount=e.toTokenAmount??"",this.inputError=e.inputError,e.inputError&&h.goBack(),this.loadingQuote=e.loadingQuote,this.loadingApprovalTransaction=e.loadingApprovalTransaction,this.loadingBuildTransaction=e.loadingBuildTransaction,this.loadingTransaction=e.loadingTransaction}))}firstUpdated(){b.getTransaction(),this.refreshTransaction()}disconnectedCallback(){this.unsubscribe.forEach(e=>null==e?void 0:e()),clearInterval(this.interval)}render(){return r`
      <wui-flex flexDirection="column" .padding=${["0","4","4","4"]} gap="3">
        ${this.templateSwap()}
      </wui-flex>
    `}refreshTransaction(){this.interval=setInterval(()=>{b.getApprovalLoadingState()||b.getTransaction()},1e4)}templateSwap(){var e,t,o,i;const n=`${c.formatNumberToLocalString(parseFloat(this.sourceTokenAmount))} ${null==(e=this.sourceToken)?void 0:e.symbol}`,s=`${c.formatNumberToLocalString(parseFloat(this.toTokenAmount))} ${null==(t=this.toToken)?void 0:t.symbol}`,a=parseFloat(this.sourceTokenAmount)*this.sourceTokenPriceInUSD,l=parseFloat(this.toTokenAmount)*this.toTokenPriceInUSD,u=c.formatNumberToLocalString(a),d=c.formatNumberToLocalString(l),p=this.loadingQuote||this.loadingBuildTransaction||this.loadingTransaction||this.loadingApprovalTransaction;return r`
