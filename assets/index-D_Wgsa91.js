...
`;var B=function(e,t,a,n){var s,i=arguments.length,r=i<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,a):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(e,t,a,n);else for(var o=e.length-1;o>=0;o--)(s=e[o])&&(r=(i<3?s(r):i>3?s(t,a,r):s(t,a))||r);return i>3&&r&&Object.defineProperty(t,a,r),r};let J=class extends g{constructor(){super(),this.unsubscribe=[],this.amount="",this.tokenSymbol="",this.networkName="",this.exchanges=q.state.exchanges,this.isLoading=q.state.isLoading,this.loadingExchangeId=null,this.connectedWalletInfo=d.state.connectedWalletInfo,this.initializePaymentDetails(),this.unsubscribe.push(q.subscribeKey("exchanges",e=>this.exchanges=e)),this.unsubscribe.push(q.subscribeKey("isLoading",e=>this.isLoading=e)),this.unsubscribe.push(d.subscribe(e=>this.connectedWalletInfo=e.connectedWalletInfo)),q.fetchExchanges()}get isWalletConnected(){return"connected"===d.state.status}render(){return f`
    ...
    `}initializePaymentDetails(){const e=q.getPaymentAsset();this.networkName=e.network,this.tokenSymbol=e.metadata.symbol,this.amount=q.state.amount.toString()}renderPayWithWallet(){return function(e){const{chainNamespace:a}=t.parseCaipNetworkId(e);return F.includes(a)}(this.networkName)?f`<wui-flex flexDirection="column" gap="s">
    ...
    >
      ...
      `)}onWalletPayment(){q.handlePayWithWallet()}async onExchangePayment(e){try{this.loadingExchangeId=e;const t=await q.handlePayWithExchange(e);t&&(await p.open({view:"PayLoading"}),a.openHref(t.url,t.openInNewTab?"_blank":"_self"))}catch(t){u.showError("Failed to pay with exchange")}finally{this.loadingExchangeId=null}}async onDisconnect(e){e.stopPropagation();try{await r.disconnect()}catch{u.showError("Failed to disconnect")}}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}};J.styles=z,B([v()],J.prototype,"amount",void 0),B([v()],J.prototype,"tokenSymbol",void 0),B([v()],J.prototype,"networkName",void 0),B([v()],J.prototype,"exchanges",void 0),B([v()],J.prototype,"isLoading",void 0),B([v()],J.prototype,"loadingExchangeId",void 0),B([v()],J.prototype,"connectedWalletInfo",void 0),J=B([P("w3m-pay-view")],J);const Z=y`
  :host {
    display: block;
    height: 100%;
    width: 100%;
...
`;var X=function(e,t,a,n){var s,i=arguments.length,r=i<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,a):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(e,t,a,n);else for(var o=e.length-1;o>=0;o--)(s=e[o])&&(r=(i<3?s(r):i>3?s(t,a,r):s(t,a))||r);return i>3&&r&&Object.defineProperty(t,a,r),r};let Q=class extends g{constructor(){super(),this.loadingMessage="",this.subMessage="",this.paymentState="in-progress",this.paymentState=q.state.isPaymentInProgress?"in-progress":"completed",this.updateMessages(),this.setupSubscription(),this.setupExchangeSubscription()}disconnectedCallback(){clearInterval(this.exchangeSubscription)}render(){return f`
      <wui-flex
