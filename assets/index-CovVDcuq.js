import{i as R,c as k,x as a,r as T,j as v,L as p,h as O,m as Y,O as V,k as z,A as E,W}from"./index-BoaPkzHy.js";import{n as l,c as _,o as S,r as b}from"./if-defined-B8hzyC4K.js";import{T as A,D as F}from"./index-BpYuGGVB.js";import"./index-CoTsI33h.js";import"./index-BKbKeODy.js";import"./index-D_p1t9xX.js";var N;(function(s){s.approve="approved",s.bought="bought",s.borrow="borrowed",s.burn="burnt",s.cancel="canceled",s.claim="claimed",s.deploy="deployed",s.deposit="deposited",s.execute="executed",s.mint="minted",s.receive="received",s.repay="repaid",s.send="sent",s.sell="sold",s.stake="staked",s.trade="swapped",s.unstake="unstaked",s.withdraw="withdrawn"})(N||(N={}));const U=R`
  :host > wui-flex {
    display: flex;
