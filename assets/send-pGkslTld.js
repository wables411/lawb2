import{i as e,n as t,h as i,c as n,a as r,L as o,f as s,C as a,v as l,ab as c,Q as u,x as d,r as h,e as p,ac as w,ad as f,R as g,U as v,a2 as m,a1 as x,o as k,d as b,S as y,E as $,g as A,W as T}from"./appkit-vendor-C7zlPPaF.js";import"./index-D5ty-7ST.js";import"./wagmi-vendor-dPYIeXYB.js";import"./react-vendor-CFG7hIzY.js";const C=e`
  :host {
    width: 100%;
    height: 100px;
...
`;var z=function(e,t,i,n){var r,o=arguments.length,s=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,n);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(o<3?r(s):o>3?r(t,i,s):r(t,i))||s);return o>3&&s&&Object.defineProperty(t,i,s),s};let D=class extends r{constructor(){super(),this.unsubscribe=[],this.token=c.state.token,this.sendTokenAmount=c.state.sendTokenAmount,this.receiverAddress=c.state.receiverAddress,this.receiverProfileName=c.state.receiverProfileName,this.loading=c.state.loading,this.message="Preview Send",this.token&&(this.fetchBalances(),this.fetchNetworkPrice()),this.unsubscribe.push(c.subscribe(e=>{this.token=e.token,this.sendTokenAmount=e.sendTokenAmount,this.receiverAddress=e.receiverAddress,this.receiverProfileName=e.receiverProfileName,this.loading=e.loading}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return this.getMessage(),d` <wui-flex flexDirection="column" .padding=${["0","l","l","l"]}>
    ...
    </wui-flex>`}async fetchBalances(){await c.fetchTokenBalance(),c.fetchNetworkBalance()}async fetchNetworkPrice(){await x.getNetworkTokenPrice()}onButtonClick(){g.push("WalletSendPreview")}getMessage(){if(this.message="Preview Send",this.receiverAddress&&!s.isAddress(this.receiverAddress,a.state.activeChain)&&(this.message="Invalid Address"),this.receiverAddress||(this.message="Add Address"),this.sendTokenAmount&&this.token&&this.sendTokenAmount>Number(this.token.quantity.numeric)&&(this.message="Insufficient Funds"),this.sendTokenAmount||(this.message="Add Amount"),this.sendTokenAmount&&this.token?.price){this.sendTokenAmount*this.token.price||(this.message="Incorrect Value")}this.token||(this.message="Select Token")}};D.styles=O,z([i()],D.prototype,"token",void 0),z([i()],D.prototype,"sendTokenAmount",void 0),z([i()],D.prototype,"receiverAddress",void 0),z([i()],D.prototype,"receiverProfileName",void 0),z([i()],D.prototype,"loading",void 0),z([i()],D.prototype,"message",void 0),D=z([n("w3m-wallet-send-view")],D);const U=e`
  .contentContainer {
    height: 440px;
    overflow: scroll;
