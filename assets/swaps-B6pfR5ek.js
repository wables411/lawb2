import{Y as e,ad as t,$ as o,a0 as i,a1 as n,I as r,z as s,a2 as a,Q as l,F as u,R as c,K as d,ay as p,G as h,H as w,Z as g,_ as m,aI as k}from"./index-Bi_hX7G7.js";import{S as b}from"./SwapController-CGOqUfd6.js";import"./index-cq930PkW.js";import"./wagmi-vendor-BoUOF4ar.js";import"./react-vendor-BlDtUSDV.js";import"./chess-vendor-BKDUb1NN.js";import"./ui-vendor-RPKswk1o.js";const f={numericInputKeyDown(e,t,o){const i=e.metaKey||e.ctrlKey,n=e.key,r=n.toLocaleLowerCase(),s=","===n,a="."===n,l=n>="0"&&n<="9";!i&&("a"===r||"c"===r||"v"===r||"x"===r)&&e.preventDefault(),"0"!==t||s||a||"0"!==n||e.preventDefault(),"0"===t&&l&&(o(n),e.preventDefault()),(s||a)&&(t||(o("0."),e.preventDefault()),((null==t?void 0:t.includes("."))||(null==t?void 0:t.includes(",")))&&e.preventDefault()),l||["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"].includes(n)||a||s||e.preventDefault()}},x=e`
  :host {
    width: 100%;
  }
