import{X as e,_ as t,ad as i,$ as n,a0 as r,a2 as o,K as s,I as a,E as l,b2 as c,a1 as u,a4 as d,R as h,B as p,a5 as f,az as m,S as g,P as w,O as k,ab as v,Y as b,Z as x,a7 as y,b3 as $,ap as A,F as T,G as C}from"./index-Bk89CT66.js";import"./index-ChyQnnVB.js";import"./index-UdDtZqL_.js";import{S as R}from"./SwapController-Cry9-mWs.js";import"./wagmi-vendor-DNR7MlZp.js";import"./react-vendor-BlDtUSDV.js";import"./chess-vendor-BKDUb1NN.js";import"./ui-vendor-DXGEkimk.js";const P=e`
  :host {
    width: 100%;
    height: 100px;
...
`;var O=function(e,t,i,n){var r,o=arguments.length,s=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,n);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(o<3?r(s):o>3?r(t,i,s):r(t,i))||s);return o>3&&s&&Object.defineProperty(t,i,s),s};const D="Insufficient Funds",z="Incorrect Value",W="Invalid Address",U="Add Address",V="Add Amount",F="Select Token",H="Preview Send";let _=class extends r{constructor(){var e,t;super(),this.unsubscribe=[],this.isTryingToChooseDifferentWallet=!1,this.token=c.state.token,this.sendTokenAmount=c.state.sendTokenAmount,this.receiverAddress=c.state.receiverAddress,this.receiverProfileName=c.state.receiverProfileName,this.loading=c.state.loading,this.params=null==(e=h.state.data)?void 0:e.send,this.caipAddress=null==(t=a.getAccountData())?void 0:t.caipAddress,this.message=H,this.disconnecting=!1,this.token&&!this.params&&(this.fetchBalances(),this.fetchNetworkPrice());const i=a.subscribeKey("activeCaipAddress",e=>{!e&&this.isTryingToChooseDifferentWallet&&(this.isTryingToChooseDifferentWallet=!1,m.open({view:"Connect",data:{redirectView:"WalletSend"}}).catch(()=>null),i())});this.unsubscribe.push(a.subscribeAccountStateProp("caipAddress",e=>{this.caipAddress=e}),c.subscribe(e=>{this.token=e.token,this.sendTokenAmount=e.sendTokenAmount,this.receiverAddress=e.receiverAddress,this.receiverProfileName=e.receiverProfileName,this.loading=e.loading}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}async firstUpdated(){await this.handleSendParameters()}render(){this.getMessage();const e=Boolean(this.params);return u` <wui-flex flexDirection="column" .padding=${["0","4","4","4"]}>
    ...
    </wui-flex>`}async handleSendParameters(){if(this.loading=!0,!this.params)return void(this.loading=!1);const e=Number(this.params.amount);if(isNaN(e))return g.showError("Invalid amount"),void(this.loading=!1);const{namespace:t,chainId:i,assetAddress:n}=this.params;if(!w.SEND_PARAMS_SUPPORTED_CHAINS.includes(t))return g.showError(`Chain "${t}" is not supported for send parameters`),void(this.loading=!1);const r=a.getCaipNetworkById(i,t);if(!r)return g.showError(`Network with id "${i}" not found`),void(this.loading=!1);try{const{balance:t,name:i,symbol:o,decimals:s}=await k.fetchERC20Balance({caipAddress:this.caipAddress,assetAddress:n,caipNetwork:r});if(!(i&&o&&s&&t))return void g.showError("Token not found");c.setToken({name:i,symbol:o,chainId:r.id.toString(),address:`${r.chainNamespace}:${r.id}:${n}`,value:0,price:0,quantity:{decimals:s.toString(),numeric:t.toString()},iconUrl:v.getTokenImage(o)??""}),c.setTokenAmount(e),c.setReceiverAddress(this.params.to)}catch(o){console.error("Failed to load token information:",o),g.showError("Failed to load token information")}finally{this.loading=!1}}};_.styles=j,O([i()],_.prototype,"token",void 0),O([i()],_.prototype,"sendTokenAmount",void 0),O([i()],_.prototype,"receiverAddress",void 0),O([i()],_.prototype,"receiverProfileName",void 0),O([i()],_.prototype,"loading",void 0),O([i()],_.prototype,"params",void 0),O([i()],_.prototype,"caipAddress",void 0),O([i()],_.prototype,"message",void 0),O([i()],_.prototype,"disconnecting",void 0),_=O([n("w3m-wallet-send-view")],_);const L=e`
  .contentContainer {
    height: 440px;
    overflow: scroll;
