import{Y as t,Z as e,_ as i,$ as a,a0 as n,a1 as o,a3 as r,a4 as s,a2 as p,a5 as l,a6 as u}from"./index-Bi_hX7G7.js";const h=t`
  :host {
    position: relative;
...
`;var d=function(t,e,i,a){var n,o=arguments.length,r=o<3?e:null===a?a=Object.getOwnPropertyDescriptor(e,i):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,i,a);else for(var s=t.length-1;s>=0;s--)(n=t[s])&&(r=(o<3?n(r):o>3?n(e,i,r):n(e,i))||r);return o>3&&r&&Object.defineProperty(e,i,r),r};let c=class extends o{constructor(){super(...arguments),this.inputElementRef=r(),this.disabled=!1,this.value="",this.placeholder="0",this.widthVariant="auto",this.maxDecimals=void 0,this.maxIntegers=void 0,this.fontSize="h4",this.error=!1}firstUpdated(){this.resizeInput()}updated(){this.style.setProperty("--local-font-size",s.textSize[this.fontSize]),this.resizeInput()}render(){var t;return this.dataset.widthVariant=this.widthVariant,this.dataset.error=String(this.error),(null==(t=this.inputElementRef)?void 0:t.value)&&this.value&&(this.inputElementRef.value.value=this.value),"auto"===this.widthVariant?this.inputTemplate():p`
    ...
    />`}dispatchInputChangeEvent(){this.inputElementRef.value&&(this.inputElementRef.value.value=u.maskInput({value:this.inputElementRef.value.value,decimals:this.maxDecimals,integers:this.maxIntegers}),this.dispatchEvent(new CustomEvent("inputChange",{detail:this.inputElementRef.value.value,bubbles:!0,composed:!0})),this.resizeInput())}resizeInput(){if("fit"===this.widthVariant){const t=this.inputElementRef.value;if(t){const e=t.previousElementSibling;e&&(e.textContent=t.value||"0",t.style.width=`${e.offsetWidth}px`)}}}};c.styles=[e,i,h],d([a({type:Boolean})],c.prototype,"disabled",void 0),d([a({type:String})],c.prototype,"value",void 0),d([a({type:String})],c.prototype,"placeholder",void 0),d([a({type:String})],c.prototype,"widthVariant",void 0),d([a({type:Number})],c.prototype,"maxDecimals",void 0),d([a({type:Number})],c.prototype,"maxIntegers",void 0),d([a({type:String})],c.prototype,"fontSize",void 0),d([a({type:Boolean})],c.prototype,"error",void 0),c=d([n("wui-input-amount")],c);
