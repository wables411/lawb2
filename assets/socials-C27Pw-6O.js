import{i as e,I as t,L as i,d as o,c as r,z as s,O as a,R as n,v as c,x as l,P as d,q as u,Q as h,s as p,V as w,K as g,A as m,C as v,o as f,X as b,E as x,Y as y,S as C,Z as k,_ as P,T as S}from"./index-Btd-CX-y.js";import"./wagmi-vendor-IFnMmY1D.js";import"./react-vendor-ZyuiJZO_.js";import"./chess-vendor-JTxzwGi1.js";import"./ui-vendor-BgPmeekb.js";const E=e`
  :host {
...
`;var I=function(e,t,i,o){var r,s=arguments.length,a=s<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,o);else for(var n=e.length-1;n>=0;n--)(r=e[n])&&(a=(s<3?r(a):s>3?r(t,i,a):r(t,i))||a);return s>3&&a&&Object.defineProperty(t,i,a),a};let $=class extends r{constructor(){super(),this.unsubscribe=[],this.tabIdx=void 0,this.connectors=s.state.connectors,this.authConnector=this.connectors.find(e=>"AUTH"===e.type),this.remoteFeatures=a.state.remoteFeatures,this.isPwaLoading=!1,this.unsubscribe.push(s.subscribeKey("connectors",e=>{this.connectors=e,this.authConnector=this.connectors.find(e=>"AUTH"===e.type)}),a.subscribeKey("remoteFeatures",e=>this.remoteFeatures=e))}connectedCallback(){super.connectedCallback(),this.handlePwaFrameLoad()}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var e;let t=(null==(e=this.remoteFeatures)?void 0:e.socials)||[];const i=Boolean(this.authConnector),o=null==t?void 0:t.length,r="ConnectSocials"===n.state.view;return i&&o||r?(r&&!o&&(t=c.DEFAULT_SOCIALS),l` <wui-flex flexDirection="column" gap="xs">
      ${t.map(e=>l`<wui-list-social
          ...
          ></wui-list-social>`)}
    </wui-flex>`):null}async onSocialClick(e){e&&await d(e)}async handlePwaFrameLoad(){var e;if(u.isPWA()){this.isPwaLoading=!0;try{(null==(e=this.authConnector)?void 0:e.provider)instanceof h&&await this.authConnector.provider.init()}catch(t){p.open({displayMessage:"Error loading embedded wallet in PWA",debugMessage:t.message},"error")}finally{this.isPwaLoading=!1}}}};$.styles=E,I([t()],$.prototype,"tabIdx",void 0),I([i()],$.prototype,"connectors",void 0),I([i()],$.prototype,"authConnector",void 0),I([i()],$.prototype,"remoteFeatures",void 0),I([i()],$.prototype,"isPwaLoading",void 0),$=I([o("w3m-social-login-list")],$);const L=e`
  wui-flex {
