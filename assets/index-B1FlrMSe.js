...
`;var V=function(e,t,a,n){var s,r=arguments.length,i=r<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,a):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)i=Reflect.decorate(e,t,a,n);else for(var o=e.length-1;o>=0;o--)(s=e[o])&&(i=(r<3?s(i):r>3?s(t,a,i):s(t,a))||i);return r>3&&i&&Object.defineProperty(t,a,i),i};let z=class extends w{constructor(){var e;super(),this.unsubscribe=[],this.amount="",this.tokenSymbol="",this.networkName="",this.exchanges=q.state.exchanges,this.isLoading=q.state.isLoading,this.loadingExchangeId=null,this.connectedWalletInfo=null==(e=n.getAccountData())?void 0:e.connectedWalletInfo,this.initializePaymentDetails(),this.unsubscribe.push(q.subscribeKey("exchanges",e=>this.exchanges=e)),this.unsubscribe.push(q.subscribeKey("isLoading",e=>this.isLoading=e)),this.unsubscribe.push(n.subscribeChainProp("accountState",e=>{this.connectedWalletInfo=null==e?void 0:e.connectedWalletInfo})),q.fetchExchanges()}get isWalletConnected(){const e=n.getAccountData();return"connected"===(null==e?void 0:e.status)}render(){return g`
    ...
    `}initializePaymentDetails(){const e=q.getPaymentAsset();this.networkName=e.network,this.tokenSymbol=e.metadata.symbol,this.amount=q.state.amount.toString()}renderPayWithWallet(){return function(e){const{chainNamespace:a}=t.parseCaipNetworkId(e);return j.includes(a)}(this.networkName)?g`<wui-flex flexDirection="column" gap="3">
