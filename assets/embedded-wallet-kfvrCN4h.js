import{s as e,i as t,a5 as i,a1 as o,x as r,J as n,Z as s,ah as a,_ as d,h as c,c as l,e as u,f as p,n as h,H as m,M as g,j as f,ai as b,z as w,A as y,aj as v,k as x,u as $,E as k,y as S,W as R,S as E,ak as A,R as C}from"./index-dukl0kyM.js";import"./wagmi-vendor-BOLjgord.js";import"./react-vendor-ZyuiJZO_.js";import"./chess-vendor-JTxzwGi1.js";import"./ui-vendor-BgPmeekb.js";const T=e`
  div {
    width: 100%;
  }
...
`;var j=function(e,t,i,o){var r,n=arguments.length,s=n<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,o);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(n<3?r(s):n>3?r(t,i,s):r(t,i))||s);return n>3&&s&&Object.defineProperty(t,i,s),s};const I={sm:"md-regular",md:"lg-regular",lg:"lg-regular"},D={success:"sealCheck",error:"warning",warning:"exclamationCircle"};let P=class extends t{constructor(){super(...arguments),this.type="success",this.size="md",this.imageSrc=void 0,this.disabled=!1,this.href="",this.text=void 0}render(){return r`
      <a
        rel="noreferrer"
        target="_blank"
        href=${this.href}
    ...
    `}imageTemplate(){return this.imageSrc?r`<wui-image src=${this.imageSrc} size="inherit"></wui-image>`:r`<wui-icon
      ...
      size="inherit"
      class="image-icon"
    ></wui-icon>`}};P.styles=[u,p,z],j([h()],P.prototype,"type",void 0),j([h()],P.prototype,"size",void 0),j([h()],P.prototype,"imageSrc",void 0),j([h({type:Boolean})],P.prototype,"disabled",void 0),j([h()],P.prototype,"href",void 0),j([h()],P.prototype,"text",void 0),P=j([c("wui-semantic-chip")],P);let _=class extends t{render(){return r`
