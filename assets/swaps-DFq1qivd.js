import{X as e,ad as t,_ as o,$ as i,a0 as n,I as r,B as s,a1 as a,P as l,G as u,R as c,K as d,az as p,H as h,W as w,Y as g,Z as m,aK as k}from"./index-Syccexyz.js";import{S as b}from"./SwapController-BVKbnuJU.js";import"./index-Dx7rPlPH.js";import"./wagmi-vendor-DNR7MlZp.js";import"./react-vendor-BlDtUSDV.js";import"./chess-vendor-BKDUb1NN.js";import"./ui-vendor-DXGEkimk.js";const f={numericInputKeyDown(e,t,o){const i=e.metaKey||e.ctrlKey,n=e.key,r=n.toLocaleLowerCase(),s=","===n,a="."===n,l=n>="0"&&n<="9";!i&&("a"===r||"c"===r||"v"===r||"x"===r)&&e.preventDefault(),"0"!==t||s||a||"0"!==n||e.preventDefault(),"0"===t&&l&&(o(n),e.preventDefault()),(s||a)&&(t||(o("0."),e.preventDefault()),((null==t?void 0:t.includes("."))||(null==t?void 0:t.includes(",")))&&e.preventDefault()),l||["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"].includes(n)||a||s||e.preventDefault()}},x=e`
  :host {
    width: 100%;
  }
