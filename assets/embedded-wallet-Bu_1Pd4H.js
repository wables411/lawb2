import{o as e,j as t,af as i,ab as o,x as r,I as n,a7 as s,ar as a,a8 as d,i as l,f as c,r as u,h as p,n as h,G as m,L as g,k as f,as as b,t as w,y,at as v,l as x,q as $,E as k,s as S,W as R,S as E,au as A,R as C}from"./index-H5ayRRQL.js";import"./wagmi-vendor-BlnX2Ri9.js";import"./react-vendor-ZyuiJZO_.js";import"./chess-vendor-JTxzwGi1.js";import"./ui-vendor-BgPmeekb.js";const T=e`
  div {
    width: 100%;
  }
...
`;var z=function(e,t,i,o){var r,n=arguments.length,s=n<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,o);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(n<3?r(s):n>3?r(t,i,s):r(t,i))||s);return n>3&&s&&Object.defineProperty(t,i,s),s};const j={sm:"md-regular",md:"lg-regular",lg:"lg-regular"},D={success:"sealCheck",error:"warning",warning:"exclamationCircle"};let P=class extends t{constructor(){super(...arguments),this.type="success",this.size="md",this.imageSrc=void 0,this.disabled=!1,this.href="",this.text=void 0}render(){return r`
    ...
    `}imageTemplate(){return this.imageSrc?r`<wui-image src=${this.imageSrc} size="inherit"></wui-image>`:r`<wui-icon
      ...
      size="inherit"
      class="image-icon"
    ></wui-icon>`}};P.styles=[u,p,I],z([h()],P.prototype,"type",void 0),z([h()],P.prototype,"size",void 0),z([h()],P.prototype,"imageSrc",void 0),z([h({type:Boolean})],P.prototype,"disabled",void 0),z([h()],P.prototype,"href",void 0),z([h()],P.prototype,"text",void 0),P=z([l("wui-semantic-chip")],P);let _=class extends t{render(){return r`
...
`;var B=function(e,t,i,o){var r,n=arguments.length,s=n<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,o);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(n<3?r(s):n>3?r(t,i,s):r(t,i))||s);return n>3&&s&&Object.defineProperty(t,i,s),s};let M=class extends t{constructor(){super(...arguments),this.name="",this.registered=!1,this.loading=!1,this.disabled=!1}render(){return r`
    ...
    `}templateRightContent(){return this.loading?r`<wui-loading-spinner size="lg" color="primary"></wui-loading-spinner>`:this.registered?r`<wui-tag variant="info" size="sm">Registered</wui-tag>`:r`<wui-tag variant="success" size="sm">Available</wui-tag>`}};M.styles=[u,p,U],B([h()],M.prototype,"name",void 0),B([h({type:Boolean})],M.prototype,"registered",void 0),B([h({type:Boolean})],M.prototype,"loading",void 0),B([h({type:Boolean})],M.prototype,"disabled",void 0),M=B([l("wui-account-name-suggestion-item")],M);const F=c`
  :host {
    position: relative;
    width: 100%;
