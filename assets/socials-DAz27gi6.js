import{ba as E,bb as L,be as S,bv as b,br as g,bh as W,bd as l,bm as C,bx as D,by as F,bl as d,bz as j,bn as _,bo as u,bu as T,bA as U,bq as y,bB as q,bc as I,bf as P}from"./index-CEhvpO5H.js";import{n as z,r as c,c as k,o as v}from"./if-defined-DnqqGul4.js";import{O as R}from"./index-BGlfy51z.js";import{e as M}from"./index-Cz_gocGy.js";import"./index-C7n6MmmY.js";import"./index-B48HZYyJ.js";import"./index-CDT6TZPd.js";import"./index-DcE-wB-4.js";import"./index-BQtmnjrh.js";import"./index-MSKLSjBT.js";import"./ref-CorrK4Ok.js";import"./ConstantsUtil-Dmg8YACJ.js";import"./index-CTbfiYgY.js";import"./index-DBPGxzWp.js";const N=E`
  :host {
...
`;var w=function(s,e,i,o){var n=arguments.length,t=n<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(s,e,i,o);else for(var a=s.length-1;a>=0;a--)(r=s[a])&&(t=(n<3?r(t):n>3?r(e,i,t):r(e,i))||t);return n>3&&t&&Object.defineProperty(e,i,t),t};let h=class extends L{constructor(){super(),this.unsubscribe=[],this.tabIdx=void 0,this.connectors=S.state.connectors,this.authConnector=this.connectors.find(e=>e.type==="AUTH"),this.remoteFeatures=b.state.remoteFeatures,this.isPwaLoading=!1,this.unsubscribe.push(S.subscribeKey("connectors",e=>{this.connectors=e,this.authConnector=this.connectors.find(i=>i.type==="AUTH")}),b.subscribeKey("remoteFeatures",e=>this.remoteFeatures=e))}connectedCallback(){super.connectedCallback(),this.handlePwaFrameLoad()}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var t;let e=((t=this.remoteFeatures)==null?void 0:t.socials)||[];const i=!!this.authConnector,o=e==null?void 0:e.length,n=g.state.view==="ConnectSocials";return(!i||!o)&&!n?null:(n&&!o&&(e=W.DEFAULT_SOCIALS),l` <wui-flex flexDirection="column" gap="xs">
      ${e.map(r=>l`<wui-list-social
          ...
          ></wui-list-social>`)}
    </wui-flex>`)}async onSocialClick(e){e&&await M(e)}async handlePwaFrameLoad(){var e;if(C.isPWA()){this.isPwaLoading=!0;try{((e=this.authConnector)==null?void 0:e.provider)instanceof D&&await this.authConnector.provider.init()}catch(i){F.open({shortMessage:"Error loading embedded wallet in PWA",longMessage:i.message},"error")}finally{this.isPwaLoading=!1}}}};h.styles=N;w([z()],h.prototype,"tabIdx",void 0);w([c()],h.prototype,"connectors",void 0);w([c()],h.prototype,"authConnector",void 0);w([c()],h.prototype,"remoteFeatures",void 0);w([c()],h.prototype,"isPwaLoading",void 0);h=w([k("w3m-social-login-list")],h);const V=E`
  wui-flex {
