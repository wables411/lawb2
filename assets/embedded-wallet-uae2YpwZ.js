import{w as e,p as t,af as i,ab as o,x as r,O as n,a7 as s,ar as a,a8 as d,o as l,j as c,k as u,l as p,n as h,L as m,T as g,q as f,as as b,F as w,H as y,at as v,t as x,B as $,E as k,D as S,W as R,S as E,au as A,R as C}from"./index-F-ZNMlWE.js";import"./wagmi-vendor-BlnX2Ri9.js";import"./react-vendor-ZyuiJZO_.js";import"./chess-vendor-JTxzwGi1.js";import"./ui-vendor-BgPmeekb.js";const T=e`
  div {
    width: 100%;
  }
...
`;var I=function(e,t,i,o){var r,n=arguments.length,s=n<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,o);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(n<3?r(s):n>3?r(t,i,s):r(t,i))||s);return n>3&&s&&Object.defineProperty(t,i,s),s};const j={sm:"md-regular",md:"lg-regular",lg:"lg-regular"},D={success:"sealCheck",error:"warning",warning:"exclamationCircle"};let P=class extends t{constructor(){super(...arguments),this.type="success",this.size="md",this.imageSrc=void 0,this.disabled=!1,this.href="",this.text=void 0}render(){return r`
    ...
    `}imageTemplate(){return this.imageSrc?r`<wui-image src=${this.imageSrc} size="inherit"></wui-image>`:r`<wui-icon
      ...
      size="inherit"
      class="image-icon"
    ></wui-icon>`}};P.styles=[u,p,z],I([h()],P.prototype,"type",void 0),I([h()],P.prototype,"size",void 0),I([h()],P.prototype,"imageSrc",void 0),I([h({type:Boolean})],P.prototype,"disabled",void 0),I([h()],P.prototype,"href",void 0),I([h()],P.prototype,"text",void 0),P=I([l("wui-semantic-chip")],P);let _=class extends t{render(){return r`
    ...
    `}};_=function(e,t,i,o){var r,n=arguments.length,s=n<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,o);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(n<3?r(s):n>3?r(t,i,s):r(t,i))||s);return n>3&&s&&Object.defineProperty(t,i,s),s}([l("w3m-upgrade-wallet-view")],_);const B=c`
  :host {
    width: 100%;
  }
...
`;var U=function(e,t,i,o){var r,n=arguments.length,s=n<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,o);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(n<3?r(s):n>3?r(t,i,s):r(t,i))||s);return n>3&&s&&Object.defineProperty(t,i,s),s};let M=class extends t{constructor(){super(...arguments),this.name="",this.registered=!1,this.loading=!1,this.disabled=!1}render(){return r`
    ...
    `}templateRightContent(){return this.loading?r`<wui-loading-spinner size="lg" color="primary"></wui-loading-spinner>`:this.registered?r`<wui-tag variant="info" size="sm">Registered</wui-tag>`:r`<wui-tag variant="success" size="sm">Available</wui-tag>`}};M.styles=[u,p,B],U([h()],M.prototype,"name",void 0),U([h({type:Boolean})],M.prototype,"registered",void 0),U([h({type:Boolean})],M.prototype,"loading",void 0),U([h({type:Boolean})],M.prototype,"disabled",void 0),M=U([l("wui-account-name-suggestion-item")],M);const F=c`
  :host {
    position: relative;
    width: 100%;
...
`;var K=function(e,t,i,o){var r,n=arguments.length,s=n<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,o);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(n<3?r(s):n>3?r(t,i,s):r(t,i))||s);return n>3&&s&&Object.defineProperty(t,i,s),s};let Y=class extends t{constructor(){super(...arguments),this.disabled=!1,this.loading=!1}render(){return r`
      ...
      ></wui-input-text>
    `}};Y.styles=[u,F],K([h()],Y.prototype,"errorMessage",void 0),K([h({type:Boolean})],Y.prototype,"disabled",void 0),K([h()],Y.prototype,"value",void 0),K([h({type:Boolean})],Y.prototype,"loading",void 0),K([h({attribute:!1})],Y.prototype,"onKeyDown",void 0),Y=K([l("wui-ens-input")],Y);const L=c`
  wui-flex {
    width: 100%;
  }
...
`;let G=class extends t{render(){return r`
    ...
    </wui-flex>`}redirectToAccount(){C.replace("Account")}};G.styles=V,G=function(e,t,i,o){var r,n=arguments.length,s=n<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,o);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(n<3?r(s):n>3?r(t,i,s):r(t,i))||s);return n>3&&s&&Object.defineProperty(t,i,s),s}([l("w3m-register-account-name-success-view")],G);export{O as W3mApproveTransactionView,G as W3mRegisterAccountNameSuccess,H as W3mRegisterAccountNameView,_ as W3mUpgradeWalletView};
