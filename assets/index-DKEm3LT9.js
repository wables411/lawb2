import{ba as R,bb as k,bd as a,bi as L,bn as v,bN as p,bm as O,br as Y,bv as V,bo as z,bl as E,bp as F}from"./index-DKjFbvtN.js";import{n as l,c as _,o as j,r as b}from"./if-defined-CU4xiWiq.js";import{T as A,D as W}from"./index-DPhHmrVR.js";import"./index-BrEyYusH.js";import"./index-Cr5dB_a6.js";import"./index-BJSL9cP-.js";var N;(function(s){s.approve="approved",s.bought="bought",s.borrow="borrowed",s.burn="burnt",s.cancel="canceled",s.claim="claimed",s.deploy="deployed",s.deposit="deposited",s.execute="executed",s.mint="minted",s.receive="received",s.repay="repaid",s.send="sent",s.sell="sold",s.stake="staked",s.trade="swapped",s.unstake="unstaked",s.withdraw="withdrawn"})(N||(N={}));const U=R`
  :host > wui-flex {
    display: flex;
