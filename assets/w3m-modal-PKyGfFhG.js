...
`;var N=function(e,t,o,i){var r,a=arguments.length,n=a<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,o,i);else for(var s=e.length-1;s>=0;s--)(r=e[s])&&(n=(a<3?r(n):a>3?r(t,o,n):r(t,o))||n);return a>3&&n&&Object.defineProperty(t,o,n),n};const T={info:"info",success:"checkmark",warning:"warningCircle",error:"warning"};let D=class extends s{constructor(){super(...arguments),this.message="",this.type="info"}render(){return l`
    ...
    `}onClose(){p.close()}};D.styles=[a,A],N([c()],D.prototype,"message",void 0),N([c()],D.prototype,"type",void 0),D=N([n("wui-alertbar")],D);const j=r`
  :host {
    display: block;
    position: absolute;
    top: ${({spacing:e})=>e[3]};
...
`;var B=function(e,t,o,i){var r,a=arguments.length,n=a<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,o,i);else for(var s=e.length-1;s>=0;s--)(r=e[s])&&(n=(a<3?r(n):a>3?r(t,o,n):r(t,o))||n);return a>3&&n&&Object.defineProperty(t,o,n),n};const L={info:{backgroundColor:"fg-350",iconColor:"fg-325",icon:"info"},success:{backgroundColor:"success-glass-reown-020",iconColor:"success-125",icon:"checkmark"},warning:{backgroundColor:"warning-glass-reown-020",iconColor:"warning-100",icon:"warningCircle"},error:{backgroundColor:"error-glass-reown-020",iconColor:"error-125",icon:"warning"}};let H=class extends s{constructor(){super(),this.unsubscribe=[],this.open=p.state.open,this.onOpen(!0),this.unsubscribe.push(p.subscribeKey("open",e=>{this.open=e,this.onOpen(!1)}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){const{message:e,variant:t}=p.state,o=L[t];return l`
      <wui-alertbar
        ...
        type=${t}
      ></wui-alertbar>
    `}onOpen(e){this.open?(this.animate([{opacity:0,transform:"scale(0.85)"},{opacity:1,transform:"scale(1)"}],{duration:150,fill:"forwards",easing:"ease"}),this.style.cssText="pointer-events: auto"):e||(this.animate([{opacity:1,transform:"scale(1)"},{opacity:0,transform:"scale(0.85)"}],{duration:150,fill:"forwards",easing:"ease"}),this.style.cssText="pointer-events: none")}};H.styles=j,B([u()],H.prototype,"open",void 0),H=B([n("w3m-alertbar")],H);const V=r`
  button {
    display: block;
    display: flex;
    align-items: center;
...
`;var M=function(e,t,o,i){var r,a=arguments.length,n=a<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,o,i);else for(var s=e.length-1;s>=0;s--)(r=e[s])&&(n=(a<3?r(n):a>3?r(t,o,n):r(t,o))||n);return a>3&&n&&Object.defineProperty(t,o,n),n};const G=["SmartSessionList"],q={PayWithExchange:m.tokens.theme.foregroundPrimary};function _(){var e,t,i,r,a,n,s,l;const c=null==(t=null==(e=o.state.data)?void 0:e.connector)?void 0:t.name,d=null==(r=null==(i=o.state.data)?void 0:i.wallet)?void 0:r.name,p=null==(n=null==(a=o.state.data)?void 0:a.network)?void 0:n.name,u=d??c,h=k.getConnectors(),m=1===h.length&&"w3m-email"===(null==(s=h[0])?void 0:s.id),g=null==(l=w.getAccountData())?void 0:l.socialProvider;return{Connect:`Connect ${m?"Email":""} Wallet`,Create:"Create Wallet",ChooseAccountName:void 0,Account:void 0,AccountSettings:void 0,AllWallets:"All Wallets",ApproveTransaction:"Approve Transaction",BuyInProgress:"Buy",UsageExceeded:"Usage Exceeded",ConnectingExternal:u??"Connect Wallet",ConnectingWalletConnect:u??"WalletConnect",ConnectingWalletConnectBasic:"WalletConnect",ConnectingSiwe:"Sign In",Convert:"Convert",ConvertSelectToken:"Select token",ConvertPreview:"Preview Convert",Downloads:u?`Get ${u}`:"Downloads",EmailLogin:"Email Login",EmailVerifyOtp:"Confirm Email",EmailVerifyDevice:"Register Device",GetWallet:"Get a Wallet",Networks:"Choose Network",OnRampProviders:"Choose Provider",OnRampActivity:"Activity",OnRampTokenSelect:"Select Token",OnRampFiatSelect:"Select Currency",Pay:"How you pay",ProfileWallets:"Wallets",SwitchNetwork:p??"Switch Network",Transactions:"Activity",UnsupportedChain:"Switch Network",UpgradeEmailWallet:"Upgrade Your Wallet",UpdateEmailWallet:"Edit Email",UpdateEmailPrimaryOtp:"Confirm Current Email",UpdateEmailSecondaryOtp:"Confirm New Email",WhatIsABuy:"What is Buy?",RegisterAccountName:"Choose Name",RegisterAccountNameSuccess:"",WalletReceive:"Receive",WalletCompatibleNetworks:"Compatible Networks",Swap:"Swap",SwapSelectToken:"Select Token",SwapPreview:"Preview Swap",WalletSend:"Send",WalletSendPreview:"Review Send",WalletSendSelectToken:"Select Token",WalletSendConfirmed:"Confirmed",WhatIsANetwork:"What is a network?",WhatIsAWallet:"What is a Wallet?",ConnectWallets:"Connect Wallet",ConnectSocials:"All Socials",ConnectingSocial:g?g.charAt(0).toUpperCase()+g.slice(1):"Connect Social",ConnectingMultiChain:"Select Chain",ConnectingFarcaster:"Farcaster",SwitchActiveChain:"Switch Chain",SmartSessionCreated:void 0,SmartSessionList:"Smart Sessions",SIWXSignMessage:"Sign In",PayLoading:"Payment in Progress",DataCapture:"Profile",DataCaptureOtpConfirm:"Confirm Email",FundWallet:"Fund Wallet",PayWithExchange:"Deposit from Exchange",PayWithExchangeSelectAsset:"Select Asset"}}let Q=class extends s{constructor(){super(),this.unsubscribe=[],this.heading=_()[o.state.view],this.network=w.state.activeCaipNetwork,this.networkImage=g.getNetworkImage(this.network),this.showBack=!1,this.prevHistoryLength=1,this.view=o.state.view,this.viewDirection="",this.unsubscribe.push(b.subscribeNetworkImages(()=>{this.networkImage=g.getNetworkImage(this.network)}),o.subscribeKey("view",e=>{setTimeout(()=>{this.view=e,this.heading=_()[e]},f.ANIMATION_DURATIONS.HeaderText),this.onViewChange(),this.onHistoryChange()}),w.subscribeKey("activeCaipNetwork",e=>{this.network=e,this.networkImage=g.getNetworkImage(this.network)}))}disconnectCallback(){this.unsubscribe.forEach(e=>e())}render(){const e=q[o.state.view]??m.tokens.theme.backgroundPrimary;return this.style.setProperty("--local-header-background-color",e),l`
      <wui-flex
        .padding=${["0","4","0","4"]}
        justifyContent="space-between"
        alignItems="center"
...
`;var Z=function(e,t,o,i){var r,a=arguments.length,n=a<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,o,i);else for(var s=e.length-1;s>=0;s--)(r=e[s])&&(n=(a<3?r(n):a>3?r(t,o,n):r(t,o))||n);return a>3&&n&&Object.defineProperty(t,o,n),n};let ee=class extends s{constructor(){super(...arguments),this.message="",this.variant="success"}render(){return l`
    ...
    ></wui-icon-box>`}};ee.styles=[a,J],Z([c()],ee.prototype,"message",void 0),Z([c()],ee.prototype,"variant",void 0),ee=Z([n("wui-snackbar")],ee);const te=x`
  :host {
    display: block;
    position: absolute;
    opacity: 0;
...
`;var ae=function(e,t,o,i){var r,a=arguments.length,n=a<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,o,i);else for(var s=e.length-1;s>=0;s--)(r=e[s])&&(n=(a<3?r(n):a>3?r(t,o,n):r(t,o))||n);return a>3&&n&&Object.defineProperty(t,o,n),n};const ne="scroll-lock",se={PayWithExchange:"0",PayWithExchangeSelectAsset:"0"};class le extends s{constructor(){super(),this.unsubscribe=[],this.abortController=void 0,this.hasPrefetched=!1,this.enableEmbedded=v.state.enableEmbedded,this.open=e.state.open,this.caipAddress=w.state.activeCaipAddress,this.caipNetwork=w.state.activeCaipNetwork,this.shake=e.state.shake,this.filterByNamespace=k.state.filterByNamespace,this.padding=m.spacing[1],this.mobileFullScreen=v.state.enableMobileFullScreen,this.initializeTheming(),C.prefetchAnalyticsConfig(),this.unsubscribe.push(e.subscribeKey("open",e=>e?this.onOpen():this.onClose()),e.subscribeKey("shake",e=>this.shake=e),w.subscribeKey("activeCaipNetwork",e=>this.onNewNetwork(e)),w.subscribeKey("activeCaipAddress",e=>this.onNewAddress(e)),v.subscribeKey("enableEmbedded",e=>this.enableEmbedded=e),k.subscribeKey("filterByNamespace",e=>{var t;this.filterByNamespace===e||(null==(t=w.getAccountData(e))?void 0:t.caipAddress)||(C.fetchRecommendedWallets(),this.filterByNamespace=e)}),o.subscribeKey("view",()=>{this.dataset.border=S.hasFooter()?"true":"false",this.padding=se[o.state.view]??m.spacing[1]}))}firstUpdated(){if(this.dataset.border=S.hasFooter()?"true":"false",this.mobileFullScreen&&this.setAttribute("data-mobile-fullscreen","true"),this.caipAddress){if(this.enableEmbedded)return e.close(),void this.prefetch();this.onNewAddress(this.caipAddress)}this.open&&this.onOpen(),this.enableEmbedded&&this.prefetch()}disconnectedCallback(){this.unsubscribe.forEach(e=>e()),this.onRemoveKeyboardListener()}render(){return this.style.setProperty("--local-modal-padding",this.padding),this.enableEmbedded?l`${this.contentTemplate()}
    ...
    </wui-card>`}async onOverlayClick(e){if(e.target===e.currentTarget){if(this.mobileFullScreen)return;await this.handleClose()}}async handleClose(){await W.safeClose()}initializeTheming(){const{themeVariables:e,themeMode:t}=R.state,o=P.getColorTheme(t);I(e,o)}onClose(){this.open=!1,this.classList.remove("open"),this.onScrollUnlock(),$.hide(),this.onRemoveKeyboardListener()}onOpen(){this.open=!0,this.classList.add("open"),this.onScrollLock(),this.onAddKeyboardListener()}onScrollLock(){const e=document.createElement("style");e.dataset.w3m=ne,e.textContent="\n      body {\n        touch-action: none;\n        overflow: hidden;\n        overscroll-behavior: contain;\n      }\n      w3m-modal {\n        pointer-events: auto;\n      }\n    ",document.head.appendChild(e)}onScrollUnlock(){const e=document.head.querySelector(`style[data-w3m="${ne}"]`);e&&e.remove()}onAddKeyboardListener(){var e;this.abortController=new AbortController;const t=null==(e=this.shadowRoot)?void 0:e.querySelector("wui-card");null==t||t.focus(),window.addEventListener("keydown",e=>{if("Escape"===e.key)this.handleClose();else if("Tab"===e.key){const{tagName:o}=e.target;!o||o.includes("W3M-")||o.includes("WUI-")||null==t||t.focus()}},this.abortController)}onRemoveKeyboardListener(){var e;null==(e=this.abortController)||e.abort(),this.abortController=void 0}async onNewAddress(i){const r=w.state.isSwitchingNamespace,a="ProfileWallets"===o.state.view;!i&&!r&&!a&&e.close(),await t.initializeIfEnabled(i),this.caipAddress=i,w.setIsSwitchingNamespace(!1)}onNewNetwork(t){var i,r;const a=this.caipNetwork,n=(null==(i=null==a?void 0:a.caipNetworkId)?void 0:i.toString())!==(null==(r=null==t?void 0:t.caipNetworkId)?void 0:r.toString()),s="UnsupportedChain"===o.state.view,l=e.state.open;let c=!1;this.enableEmbedded&&"SwitchNetwork"===o.state.view&&(c=!0),n&&O.resetState(),l&&s&&(c=!0),c&&"SIWXSignMessage"!==o.state.view&&o.goBack(),this.caipNetwork=t}prefetch(){this.hasPrefetched||(C.prefetch(),C.fetchWalletsByPage({page:1}),this.hasPrefetched=!0)}}le.styles=re,ae([c({type:Boolean})],le.prototype,"enableEmbedded",void 0),ae([u()],le.prototype,"open",void 0),ae([u()],le.prototype,"caipAddress",void 0),ae([u()],le.prototype,"caipNetwork",void 0),ae([u()],le.prototype,"shake",void 0),ae([u()],le.prototype,"filterByNamespace",void 0),ae([u()],le.prototype,"padding",void 0),ae([u()],le.prototype,"mobileFullScreen",void 0);let ce=class extends le{};ce=ae([n("w3m-modal")],ce);let de=class extends le{};de=ae([n("appkit-modal")],de);const pe=r`
  .icon-box {
    width: 64px;
    height: 64px;
...
`;var me=function(e,t,o,i){var r,a=arguments.length,n=a<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,o,i);else for(var s=e.length-1;s>=0;s--)(r=e[s])&&(n=(a<3?r(n):a>3?r(t,o,n):r(t,o))||n);return a>3&&n&&Object.defineProperty(t,o,n),n};let we=class extends s{constructor(){super(...arguments),this.hasImpressionSent=!1,this.walletImages=[],this.imageSrc="",this.name="",this.size="md",this.tabIdx=void 0,this.disabled=!1,this.showAllWallets=!1,this.loading=!1,this.loadingSpinnerColor="accent-100",this.rdnsId="",this.displayIndex=void 0,this.walletRank=void 0}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback(),this.cleanupIntersectionObserver()}updated(e){super.updated(e),(e.has("name")||e.has("imageSrc")||e.has("walletRank"))&&(this.hasImpressionSent=!1);e.has("walletRank")&&this.walletRank&&!this.intersectionObserver&&this.setupIntersectionObserver()}setupIntersectionObserver(){this.intersectionObserver=new IntersectionObserver(e=>{e.forEach(e=>{!e.isIntersecting||this.loading||this.hasImpressionSent||this.sendImpressionEvent()})},{threshold:.1}),this.intersectionObserver.observe(this)}cleanupIntersectionObserver(){this.intersectionObserver&&(this.intersectionObserver.disconnect(),this.intersectionObserver=void 0)}sendImpressionEvent(){this.name&&!this.hasImpressionSent&&this.walletRank&&(this.hasImpressionSent=!0,(this.rdnsId||this.name)&&y.sendWalletImpressionEvent({name:this.name,walletRank:this.walletRank,rdnsId:this.rdnsId,view:o.state.view,displayIndex:this.displayIndex}))}render(){return l`
      ...
      ></wui-list-wallet>
    `}};we.styles=he,me([c({type:Array})],we.prototype,"walletImages",void 0),me([c()],we.prototype,"imageSrc",void 0),me([c()],we.prototype,"name",void 0),me([c()],we.prototype,"size",void 0),me([c()],we.prototype,"tagLabel",void 0),me([c()],we.prototype,"tagVariant",void 0),me([c()],we.prototype,"walletIcon",void 0),me([c()],we.prototype,"tabIdx",void 0),me([c({type:Boolean})],we.prototype,"disabled",void 0),me([c({type:Boolean})],we.prototype,"showAllWallets",void 0),me([c({type:Boolean})],we.prototype,"loading",void 0),me([c({type:String})],we.prototype,"loadingSpinnerColor",void 0),me([c()],we.prototype,"rdnsId",void 0),me([c()],we.prototype,"displayIndex",void 0),me([c()],we.prototype,"walletRank",void 0),we=me([n("w3m-list-wallet")],we);const ge=r`
  :host {
