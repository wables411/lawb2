import{P as e,X as t,ae as r,av as i,ab as o,a4 as n,Y as s,aq as a,a5 as c,V as u,U as l,z as d,a2 as p,R as m,D as h,E as y,y as g,W as w,C as f,a3 as b,S as v}from"./index-OpbypVz_.js";import{O as x}from"./react-BubDT-XU.js";import"./wagmi-vendor-Sv5HvNCH.js";import"./ui-vendor-GwtnLNQ7.js";import"./chess-vendor-C25K65co.js";import"./index-DXlL4m8D.js";import"./index.es-DHzr7Jly.js";import"./index-CFYEtFbK.js";import"./WalletConnectConnector-DkFsEmTd.js";const $=e`
  :host > wui-grid {
    max-height: 360px;
    overflow: auto;
  }
...
`;var L=function(e,t,r,i){var o,n=arguments.length,s=n<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,r):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,r,i);else for(var a=e.length-1;a>=0;a--)(o=e[a])&&(s=(n<3?o(s):n>3?o(t,r,s):o(t,r))||s);return n>3&&s&&Object.defineProperty(t,r,s),s};let U=class extends t{constructor(){super(),this.unsubscribe=[],this.selectedOnRampProvider=x.state.selectedProvider,this.uri=f.state.wcUri,this.ready=!1,this.showRetry=!1,this.buffering=!1,this.error=!1,this.isMobile=!1,this.onRetry=void 0,this.unsubscribe.push(x.subscribeKey("selectedProvider",e=>{this.selectedOnRampProvider=e}))}disconnectedCallback(){this.intervalId&&clearInterval(this.intervalId)}render(){var e,t;let r="Continue in external window";this.error?r="Buy failed":this.selectedOnRampProvider&&(r=`Buy in ${null==(e=this.selectedOnRampProvider)?void 0:e.label}`);const i=this.error?"Buy can be declined from your side or due to and error on the provider app":"We’ll notify you once your Buy is processed";return s`
      <wui-flex
    ...
    `}onTryAgain(){this.selectedOnRampProvider&&(this.error=!1,h.openHref(this.selectedOnRampProvider.url,"popupWindow","width=600,height=800,scrollbars=yes"))}tryAgainTemplate(){var e;return(null==(e=this.selectedOnRampProvider)?void 0:e.url)?s`<wui-button size="md" variant="accent" @click=${this.onTryAgain.bind(this)}>
      ...
      Try again
    </wui-button>`:null}loaderTemplate(){const e=b.state.themeVariables["--w3m-border-radius-master"],t=e?parseInt(e.replace("px",""),10):4;return s`<wui-loading-thumbnail radius=${9*t}></wui-loading-thumbnail>`}onCopyUri(){var e;if(!(null==(e=this.selectedOnRampProvider)?void 0:e.url))return v.showError("No link found"),void m.goBack();try{h.copyToClopboard(this.selectedOnRampProvider.url),v.showSuccess("Link copied")}catch{v.showError("Failed to copy")}}};U.styles=B,L([c()],U.prototype,"intervalId",void 0),L([c()],U.prototype,"selectedOnRampProvider",void 0),L([c()],U.prototype,"uri",void 0),L([c()],U.prototype,"ready",void 0),L([c()],U.prototype,"showRetry",void 0),L([c()],U.prototype,"buffering",void 0),L([c()],U.prototype,"error",void 0),L([l({type:Boolean})],U.prototype,"isMobile",void 0),L([l()],U.prototype,"onRetry",void 0),U=L([u("w3m-buy-in-progress-view")],U);let z=class extends t{render(){return s`
      <wui-flex
        flexDirection="column"
        .padding=${["6","10","5","10"]}
        alignItems="center"
    ...
    `}};z=function(e,t,r,i){var o,n=arguments.length,s=n<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,r):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,r,i);else for(var a=e.length-1;a>=0;a--)(o=e[a])&&(s=(n<3?o(s):n>3?o(t,r,s):o(t,r))||s);return n>3&&s&&Object.defineProperty(t,r,s),s}([u("w3m-what-is-a-buy-view")],z);const S=e`
  :host {
    width: 100%;
  }
...
`;var E=function(e,t,r,i){var o,n=arguments.length,s=n<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,r):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,r,i);else for(var a=e.length-1;a>=0;a--)(o=e[a])&&(s=(n<3?o(s):n>3?o(t,r,s):o(t,r))||s);return n>3&&s&&Object.defineProperty(t,r,s),s};let K=class extends t{constructor(){var e;super(),this.unsubscribe=[],this.type="Token",this.value=0,this.currencies=[],this.selectedCurrency=null==(e=this.currencies)?void 0:e[0],this.currencyImages=r.state.currencyImages,this.tokenImages=r.state.tokenImages,this.unsubscribe.push(x.subscribeKey("purchaseCurrency",e=>{e&&"Fiat"!==this.type&&(this.selectedCurrency=this.formatPurchaseCurrency(e))}),x.subscribeKey("paymentCurrency",e=>{e&&"Token"!==this.type&&(this.selectedCurrency=this.formatPaymentCurrency(e))}),x.subscribe(e=>{"Fiat"===this.type?this.currencies=e.purchaseCurrencies.map(this.formatPurchaseCurrency):this.currencies=e.paymentCurrencies.map(this.formatPaymentCurrency)}),r.subscribe(e=>{this.currencyImages={...e.currencyImages},this.tokenImages={...e.tokenImages}}))}firstUpdated(){x.getAvailableCurrencies()}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var e;const t=(null==(e=this.selectedCurrency)?void 0:e.symbol)||"",r=this.currencyImages[t]||this.tokenImages[t];return s`<wui-input-text type="number" size="lg" value=${this.value}>
    ...
    </wui-input-text>`}formatPaymentCurrency(e){return{name:e.id,symbol:e.id}}formatPurchaseCurrency(e){return{name:e.name,symbol:e.symbol}}};K.styles=S,E([l({type:String})],K.prototype,"type",void 0),E([l({type:Number})],K.prototype,"value",void 0),E([c()],K.prototype,"currencies",void 0),E([c()],K.prototype,"selectedCurrency",void 0),E([c()],K.prototype,"currencyImages",void 0),E([c()],K.prototype,"tokenImages",void 0),K=E([u("w3m-onramp-input")],K);const q=e`
  :host > wui-flex {
    width: 100%;
    max-width: 360px;
  }
...
`;var N=function(e,t,r,i){var o,n=arguments.length,s=n<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,r):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,r,i);else for(var a=e.length-1;a>=0;a--)(o=e[a])&&(s=(n<3?o(s):n>3?o(t,r,s):o(t,r))||s);return n>3&&s&&Object.defineProperty(t,r,s),s};const W={USD:"$",EUR:"€",GBP:"£"},X=[100,250,500,1e3];let F=class extends t{constructor(){super(),this.unsubscribe=[],this.disabled=!1,this.caipAddress=d.state.activeCaipAddress,this.loading=a.state.loading,this.paymentCurrency=x.state.paymentCurrency,this.paymentAmount=x.state.paymentAmount,this.purchaseAmount=x.state.purchaseAmount,this.quoteLoading=x.state.quotesLoading,this.unsubscribe.push(d.subscribeKey("activeCaipAddress",e=>this.caipAddress=e),a.subscribeKey("loading",e=>{this.loading=e}),x.subscribe(e=>{this.paymentCurrency=e.paymentCurrency,this.paymentAmount=e.paymentAmount,this.purchaseAmount=e.purchaseAmount,this.quoteLoading=e.quotesLoading}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return s`
    ...
    `}templateButton(){return this.caipAddress?s`<wui-button
        ...
        >
          Connect wallet
        </wui-button>`}getQuotes(){this.loading||a.open({view:"OnRampProviders"})}openModal(){a.open({view:"Connect"})}async onPaymentAmountChange(e){x.setPaymentAmount(Number(e.detail)),await x.getQuote()}async selectPresetAmount(e){x.setPaymentAmount(e),await x.getQuote()}};F.styles=q,N([l({type:Boolean})],F.prototype,"disabled",void 0),N([c()],F.prototype,"caipAddress",void 0),N([c()],F.prototype,"loading",void 0),N([c()],F.prototype,"paymentCurrency",void 0),N([c()],F.prototype,"paymentAmount",void 0),N([c()],F.prototype,"purchaseAmount",void 0),N([c()],F.prototype,"quoteLoading",void 0),F=N([u("w3m-onramp-widget")],F);export{U as W3mBuyInProgressView,j as W3mOnRampProvidersView,C as W3mOnrampFiatSelectView,D as W3mOnrampTokensView,F as W3mOnrampWidget,z as W3mWhatIsABuyView};
