import{k as e,i as t,x as i,n as o,Q as a,P as r}from"./index-g8dvpypy.js";import{k as s,p as n,s as c,l,M as w,S as d,R as u,h as p,A as m,j as h,i as v,C as g,m as f,n as b,o as y,E as x,O as k,q as C,u as S,v as R,x as N,T as O,y as T,z as A,B as W}from"./core-BT2S4f33.js";import{c as $,U as E}from"./index-BFrqJsW2.js";import"./wagmi-vendor-Dpe0V0Cz.js";import"./react-vendor-ZyuiJZO_.js";import"./chess-vendor-JTxzwGi1.js";import"./ui-vendor-BgPmeekb.js";import"./index.es-CqwKyKIb.js";const P=n({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),I=s({state:P,subscribe:e=>l(P,()=>e(P)),subscribeKey:(e,t)=>c(P,e,t),showTooltip({message:e,triggerRect:t,variant:i}){P.open=!0,P.message=e,P.triggerRect=t,P.variant=i},hide(){P.open=!1,P.message="",P.triggerRect={width:0,height:0,top:0,left:0}}}),j={isUnsupportedChainView:()=>"UnsupportedChain"===u.state.view||"SwitchNetwork"===u.state.view&&u.state.history.includes("UnsupportedChain"),async safeClose(){if(this.isUnsupportedChainView())return void w.shake();await d.isSIWXCloseDisabled()?w.shake():w.close()}},D=e`
  :host {
    display: block;
...
`;var L=function(e,t,i,o){var a,r=arguments.length,s=r<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,o);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(s=(r<3?a(s):r>3?a(t,i,s):a(t,i))||s);return r>3&&s&&Object.defineProperty(t,i,s),s};let U=class extends t{constructor(){super(...arguments),this.message="",this.backgroundColor="accent-100",this.iconColor="accent-100",this.icon="info"}render(){return this.style.cssText=`\n      --local-icon-bg-value: var(--wui-color-${this.backgroundColor});\n   `,i`
    ...
    `}onClose(){m.close()}};U.styles=[p,z],L([o()],U.prototype,"message",void 0),L([o()],U.prototype,"backgroundColor",void 0),L([o()],U.prototype,"iconColor",void 0),L([o()],U.prototype,"icon",void 0),U=L([$("wui-alertbar")],U);const H=e`
  :host {
    display: block;
    position: absolute;
