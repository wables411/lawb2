import{n as t,Y as e,t as r,p as o,O as a,s}from"./property-Dy6jfSJI.js";var i=Object.defineProperty,p=Object.getOwnPropertyDescriptor,V=(t,e,r,o)=>{for(var a,s=o>1?void 0:o?p(e,r):e,V=t.length-1;V>=0;V--)(a=t[V])&&(s=(o?a(e,r,s):a(s))||s);return o&&s&&i(e,r,s),s};let h=class extends t{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var t;return e`<svg
  ...
  `,V([a({type:String,reflect:!0})],h.prototype,"size",2),V([a({type:String,reflect:!0})],h.prototype,"weight",2),V([a({type:String,reflect:!0})],h.prototype,"color",2),V([a({type:Boolean,reflect:!0})],h.prototype,"mirrored",2),h=V([s("ph-browser")],h);export{h as PhBrowser};
