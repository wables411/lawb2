import{M as w,V as Z,R as c,i as v,r as j,a as y,x as l,n as P,h as se,K as re,e as p,t as L,H as ce,o as U,f as G,O as N,C as H,A as q,S as A,D as R,T as le,$ as de,d as ue,c as pe}from"./index-D9FV4b5H.js";import{c as f,n as u,r as d,o as z,U as he}from"./if-defined-dtQgSYua.js";import"./index-CIUedPfX.js";import"./index-CYANNYYk.js";import"./index-BZyLb232.js";import"./index-B0vcT1gE.js";import"./index-BaUC18Uv.js";import"./index-BU-GS6OI.js";import"./index-CemfBAkq.js";const ee={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){w.shake();return}if(await Z.isSIWXCloseDisabled()){w.shake();return}w.close()}},we=v`
  :host {
    display: block;
...
`;var T=function(s,e,t,i){var a=arguments.length,o=a<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(s,e,t,i);else for(var r=s.length-1;r>=0;r--)(n=s[r])&&(o=(a<3?n(o):a>3?n(e,t,o):n(e,t))||o);return a>3&&o&&Object.defineProperty(e,t,o),o};let k=class extends y{constructor(){super(...arguments),this.message="",this.backgroundColor="accent-100",this.iconColor="accent-100",this.icon="info"}render(){return this.style.cssText=`
   ...
   `,l`
    ...
    `}onClose(){P.close()}};k.styles=[j,fe];T([u()],k.prototype,"message",void 0);T([u()],k.prototype,"backgroundColor",void 0);T([u()],k.prototype,"iconColor",void 0);T([u()],k.prototype,"icon",void 0);k=T([f("wui-alertbar")],k);const ge=v`
  :host {
    display: block;
    position: absolute;
...
`;var C=function(s,e,t,i){var a=arguments.length,o=a<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(s,e,t,i);else for(var r=s.length-1;r>=0;r--)(n=s[r])&&(o=(a<3?n(o):a>3?n(e,t,o):n(e,t))||o);return a>3&&o&&Object.defineProperty(e,t,o),o};const F="scroll-lock";class b extends y{constructor(){super(),this.unsubscribe=[],this.abortController=void 0,this.hasPrefetched=!1,this.enableEmbedded=N.state.enableEmbedded,this.open=w.state.open,this.caipAddress=p.state.activeCaipAddress,this.caipNetwork=p.state.activeCaipNetwork,this.shake=w.state.shake,this.filterByNamespace=H.state.filterByNamespace,this.initializeTheming(),R.prefetchAnalyticsConfig(),this.unsubscribe.push(w.subscribeKey("open",e=>e?this.onOpen():this.onClose()),w.subscribeKey("shake",e=>this.shake=e),p.subscribeKey("activeCaipNetwork",e=>this.onNewNetwork(e)),p.subscribeKey("activeCaipAddress",e=>this.onNewAddress(e)),N.subscribeKey("enableEmbedded",e=>this.enableEmbedded=e),H.subscribeKey("filterByNamespace",e=>{var t;this.filterByNamespace!==e&&!((t=p.getAccountData(e))!=null&&t.caipAddress)&&(R.fetchRecommendedWallets(),this.filterByNamespace=e)}))}firstUpdated(){if(this.caipAddress){if(this.enableEmbedded){w.close(),this.prefetch();return}this.onNewAddress(this.caipAddress)}this.open&&this.onOpen(),this.enableEmbedded&&this.prefetch()}disconnectedCallback(){this.unsubscribe.forEach(e=>e()),this.onRemoveKeyboardListener()}render(){return this.style.cssText=`
    ...
    `,document.head.appendChild(e)}onScrollUnlock(){const e=document.head.querySelector(`style[data-w3m="${F}"]`);e&&e.remove()}onAddKeyboardListener(){var t;this.abortController=new AbortController;const e=(t=this.shadowRoot)==null?void 0:t.querySelector("wui-card");e==null||e.focus(),window.addEventListener("keydown",i=>{if(i.key==="Escape")this.handleClose();else if(i.key==="Tab"){const{tagName:a}=i.target;a&&!a.includes("W3M-")&&!a.includes("WUI-")&&(e==null||e.focus())}},this.abortController)}onRemoveKeyboardListener(){var e;(e=this.abortController)==null||e.abort(),this.abortController=void 0}async onNewAddress(e){const t=p.state.isSwitchingNamespace,i=ue.getPlainAddress(e);!i&&!t?w.close():t&&i&&c.goBack(),await Z.initializeIfEnabled(),this.caipAddress=e,p.setIsSwitchingNamespace(!1)}onNewNetwork(e){var V,Y,X;const t=this.caipNetwork,i=(V=t==null?void 0:t.caipNetworkId)==null?void 0:V.toString(),a=t==null?void 0:t.chainNamespace,o=(Y=e==null?void 0:e.caipNetworkId)==null?void 0:Y.toString(),n=e==null?void 0:e.chainNamespace,r=i!==o,x=r&&!(a!==n),W=(t==null?void 0:t.name)===pe.UNSUPPORTED_NETWORK_NAME,E=c.state.view==="ConnectingExternal",O=!((X=p.getAccountData(e==null?void 0:e.chainNamespace))!=null&&X.caipAddress),ae=c.state.view==="UnsupportedChain",ne=w.state.open;let I=!1;ne&&!E&&(O?r&&(I=!0):(ae||x&&!W)&&(I=!0)),I&&c.state.view!=="SIWXSignMessage"&&c.goBack(),this.caipNetwork=e}prefetch(){this.hasPrefetched||(R.prefetch(),R.fetchWalletsByPage({page:1}),this.hasPrefetched=!0)}}b.styles=Ae;C([u({type:Boolean})],b.prototype,"enableEmbedded",void 0);C([d()],b.prototype,"open",void 0);C([d()],b.prototype,"caipAddress",void 0);C([d()],b.prototype,"caipNetwork",void 0);C([d()],b.prototype,"shake",void 0);C([d()],b.prototype,"filterByNamespace",void 0);let J=class extends b{};J=C([f("w3m-modal")],J);let Q=class extends b{};Q=C([f("appkit-modal")],Q);export{Q as AppKitModal,J as W3mModal,b as W3mModalBase};
