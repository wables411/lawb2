import{q as e,u as t,O as i,v as n,x as r,a5 as o,f as s,e as a,C as l,at as c,a6 as u,y as d,r as h,t as p,au as w,av as f,R as v,N as g,U as m,M as x,L as k,S as b,E as y,d as $,W as A}from"./index-DXlF7dvv.js";import"./index-DI3gw_Lf.js";import{S as T}from"./SwapController-nrUboi6k.js";import"./wagmi-vendor-O52zNBec.js";import"./react-vendor-ZyuiJZO_.js";import"./chess-vendor-JTxzwGi1.js";import"./ui-vendor-BgPmeekb.js";const C=e`
  :host {
    width: 100%;
    height: 100px;
...
`;var B=function(e,t,i,n){var r,o=arguments.length,s=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,n);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(o<3?r(s):o>3?r(t,i,s):r(t,i))||s);return o>3&&s&&Object.defineProperty(t,i,s),s};let I=class extends r{render(){return d` <wui-flex
    ...
    >`}handleSelectButtonClick(){v.push("WalletSendSelectToken")}sendValueTemplate(){if(this.token&&this.sendTokenAmount){const e=this.token.price*this.sendTokenAmount;return d`<wui-text class="totalValue" variant="small-400" color="fg-200"
        >${e?`$${g.formatNumberToLocalString(e,2)}`:"Incorrect value"}</wui-text
...
`;var L=function(e,t,i,n){var r,o=arguments.length,s=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,n);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(o<3?r(s):o>3?r(t,i,s):r(t,i))||s);return o>3&&s&&Object.defineProperty(t,i,s),s};let F=class extends r{constructor(){super(...arguments),this.text="",this.address="",this.isAddress=!1}render(){return d`<wui-text variant="large-500" color="fg-100">${this.text}</wui-text>
      ${this.imageTemplate()}`}imageTemplate(){return this.isAddress?d`<wui-avatar address=${this.address} .imageSrc=${this.imageSrc}></wui-avatar>`:this.imageSrc?d`<wui-image src=${this.imageSrc}></wui-image>`:d`<wui-icon size="inherit" color="fg-200" name="networkPlaceholder"></wui-icon>`}};F.styles=[h,p,q],L([t()],F.prototype,"text",void 0),L([t()],F.prototype,"address",void 0),L([t()],F.prototype,"imageSrc",void 0),L([t({type:Boolean})],F.prototype,"isAddress",void 0),F=L([n("wui-preview-item")],F);const M=e`
  :host {
    display: flex;
...
`;var K=function(e,t,i,n){var r,o=arguments.length,s=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,n);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(o<3?r(s):o>3?r(t,i,s):r(t,i))||s);return o>3&&s&&Object.defineProperty(t,i,s),s};let J=class extends r{render(){return d` <wui-text variant="small-400" color="fg-200">Details</wui-text>
      ...
      ></wui-list-content>`:null}onNetworkClick(e){e&&v.push("Networks",{network:e})}};J.styles=_,K([t()],J.prototype,"receiverAddress",void 0),K([t({type:Object})],J.prototype,"caipNetwork",void 0),J=K([n("w3m-wallet-send-details")],J);const G=e`
  wui-avatar,
  wui-image {
    display: ruby;
    width: 32px;
...
`;var Q=function(e,t,i,n){var r,o=arguments.length,s=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,n);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(o<3?r(s):o>3?r(t,i,s):r(t,i))||s);return o>3&&s&&Object.defineProperty(t,i,s),s};let X=class extends r{constructor(){super(),this.unsubscribe=[],this.token=c.state.token,this.sendTokenAmount=c.state.sendTokenAmount,this.receiverAddress=c.state.receiverAddress,this.receiverProfileName=c.state.receiverProfileName,this.receiverProfileImageUrl=c.state.receiverProfileImageUrl,this.caipNetwork=a.state.activeCaipNetwork,this.loading=c.state.loading,this.unsubscribe.push(c.subscribe(e=>{this.token=e.token,this.sendTokenAmount=e.sendTokenAmount,this.receiverAddress=e.receiverAddress,this.receiverProfileName=e.receiverProfileName,this.receiverProfileImageUrl=e.receiverProfileImageUrl,this.loading=e.loading}),a.subscribeKey("activeCaipNetwork",e=>this.caipNetwork=e))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var e,t;return d` <wui-flex flexDirection="column" .padding=${["0","l","l","l"]}>
      <wui-flex gap="xs" flexDirection="column" .padding=${["0","xs","0","xs"]}>
        <wui-flex alignItems="center" justifyContent="space-between">
          ...
          <wui-preview-item
            text="${this.sendTokenAmount?m.roundNumber(this.sendTokenAmount,6,5):"unknown"} ${null==(e=this.token)?void 0:e.symbol}"
