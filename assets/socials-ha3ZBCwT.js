import{i as E,c as L,C as S,O as b,m as g,e as W,x as l,h as C,s as D,t as F,A as d,u as j,j as _,k as u,p as T,v as U,l as y,w as q,M as O,d as P}from"./index-BJiIjxWW.js";import{n as z,r as c,c as k,o as v}from"./if-defined-DPhhQ4II.js";import{O as R}from"./index-CUxRTnmX.js";import{e as M}from"./index-CGTCQ7uP.js";import"./index-BhMkUbzU.js";import"./index-CxC823F4.js";import"./index-BUr3BFPh.js";import"./index-DgvQZhvT.js";import"./index-BcmCVPJj.js";import"./index-CYk2wVnJ.js";import"./ref-CYHwThcV.js";import"./ConstantsUtil-Dmg8YACJ.js";import"./index-Wyk4v4uU.js";import"./index-CKhg2X-o.js";const N=E`
  :host {
...
`;var f=function(s,e,i,o){var n=arguments.length,t=n<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(s,e,i,o);else for(var a=s.length-1;a>=0;a--)(r=s[a])&&(t=(n<3?r(t):n>3?r(e,i,t):r(e,i))||t);return n>3&&t&&Object.defineProperty(e,i,t),t};let h=class extends L{constructor(){super(),this.unsubscribe=[],this.tabIdx=void 0,this.connectors=S.state.connectors,this.authConnector=this.connectors.find(e=>e.type==="AUTH"),this.remoteFeatures=b.state.remoteFeatures,this.isPwaLoading=!1,this.unsubscribe.push(S.subscribeKey("connectors",e=>{this.connectors=e,this.authConnector=this.connectors.find(i=>i.type==="AUTH")}),b.subscribeKey("remoteFeatures",e=>this.remoteFeatures=e))}connectedCallback(){super.connectedCallback(),this.handlePwaFrameLoad()}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var t;let e=((t=this.remoteFeatures)==null?void 0:t.socials)||[];const i=!!this.authConnector,o=e==null?void 0:e.length,n=g.state.view==="ConnectSocials";return(!i||!o)&&!n?null:(n&&!o&&(e=W.DEFAULT_SOCIALS),l` <wui-flex flexDirection="column" gap="xs">
      ${e.map(r=>l`<wui-list-social
          ...
          ></wui-list-social>`)}
    </wui-flex>`)}async onSocialClick(e){e&&await M(e)}async handlePwaFrameLoad(){var e;if(C.isPWA()){this.isPwaLoading=!0;try{((e=this.authConnector)==null?void 0:e.provider)instanceof D&&await this.authConnector.provider.init()}catch(i){F.open({shortMessage:"Error loading embedded wallet in PWA",longMessage:i.message},"error")}finally{this.isPwaLoading=!1}}}};h.styles=N;f([z()],h.prototype,"tabIdx",void 0);f([c()],h.prototype,"connectors",void 0);f([c()],h.prototype,"authConnector",void 0);f([c()],h.prototype,"remoteFeatures",void 0);f([c()],h.prototype,"isPwaLoading",void 0);h=f([k("w3m-social-login-list")],h);const V=E`
  wui-flex {
...
`;var A=function(s,e,i,o){var n=arguments.length,t=n<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(s,e,i,o);else for(var a=s.length-1;a>=0;a--)(r=s[a])&&(t=(n<3?r(t):n>3?r(e,i,t):r(e,i))||t);return n>3&&t&&Object.defineProperty(e,i,t),t};let $=class extends L{constructor(){super(),this.unsubscribe=[],this.checked=R.state.isLegalCheckboxChecked,this.unsubscribe.push(R.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var I;const{termsConditionsUrl:e,privacyPolicyUrl:i}=b.state,o=(I=b.state.features)==null?void 0:I.legalCheckbox,t=!!(e||i)&&!!o,r=t&&!this.checked,a=r?-1:void 0;return l`
