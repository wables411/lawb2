import{Y as e,P as t,am as i,a6 as o,Q as r,G as n,$ as s,au as a,a0 as d,O as c,J as l,K as u,L as p,M as h,D as m,Z as g,T as f,t as b,v as w,av as y,V as v,r as x,E as $,s as k,W as S,S as R,aw as E,R as A}from"./index-45aCrlEa.js";import{E as C}from"./WalletConnectConnector-Cf8euLfQ.js";import"./wagmi-vendor-DnWYCuMt.js";import"./react-vendor-BlDtUSDV.js";import"./chess-vendor-BKDUb1NN.js";import"./ui-vendor-CQ8lA6Z0.js";const T=e`
  div {
    width: 100%;
  }
...
`;var I=function(e,t,i,o){var r,n=arguments.length,s=n<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,o);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(n<3?r(s):n>3?r(t,i,s):r(t,i))||s);return n>3&&s&&Object.defineProperty(t,i,s),s};const j={sm:"md-regular",md:"lg-regular",lg:"lg-regular"},D={success:"sealCheck",error:"warning",warning:"exclamationCircle"};let P=class extends t{constructor(){super(...arguments),this.type="success",this.size="md",this.imageSrc=void 0,this.disabled=!1,this.href="",this.text=void 0}render(){return r`
    ...
    `}imageTemplate(){return this.imageSrc?r`<wui-image src=${this.imageSrc} size="inherit"></wui-image>`:r`<wui-icon
      ...
      size="inherit"
      class="image-icon"
    ></wui-icon>`}};P.styles=[u,p,z],I([h()],P.prototype,"type",void 0),I([h()],P.prototype,"size",void 0),I([h()],P.prototype,"imageSrc",void 0),I([h({type:Boolean})],P.prototype,"disabled",void 0),I([h()],P.prototype,"href",void 0),I([h()],P.prototype,"text",void 0),P=I([c("wui-semantic-chip")],P);let _=class extends t{render(){return r`
...
`;var U=function(e,t,i,o){var r,n=arguments.length,s=n<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,o);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(n<3?r(s):n>3?r(t,i,s):r(t,i))||s);return n>3&&s&&Object.defineProperty(t,i,s),s};let B=class extends t{constructor(){super(...arguments),this.name="",this.registered=!1,this.loading=!1,this.disabled=!1}render(){return r`
    ...
    `}templateRightContent(){return this.loading?r`<wui-loading-spinner size="lg" color="primary"></wui-loading-spinner>`:this.registered?r`<wui-tag variant="info" size="sm">Registered</wui-tag>`:r`<wui-tag variant="success" size="sm">Available</wui-tag>`}};B.styles=[u,p,M],U([h()],B.prototype,"name",void 0),U([h({type:Boolean})],B.prototype,"registered",void 0),U([h({type:Boolean})],B.prototype,"loading",void 0),U([h({type:Boolean})],B.prototype,"disabled",void 0),B=U([c("wui-account-name-suggestion-item")],B);const K=l`
  :host {
    position: relative;
    width: 100%;
...
`;var F=function(e,t,i,o){var r,n=arguments.length,s=n<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,o);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(n<3?r(s):n>3?r(t,i,s):r(t,i))||s);return n>3&&s&&Object.defineProperty(t,i,s),s};let Y=class extends t{constructor(){super(...arguments),this.disabled=!1,this.loading=!1}render(){return r`
      ...
      ></wui-input-text>
    `}};Y.styles=[u,K],F([h()],Y.prototype,"errorMessage",void 0),F([h({type:Boolean})],Y.prototype,"disabled",void 0),F([h()],Y.prototype,"value",void 0),F([h({type:Boolean})],Y.prototype,"loading",void 0),F([h({attribute:!1})],Y.prototype,"onKeyDown",void 0),Y=F([c("wui-ens-input")],Y);const W=l`
  wui-flex {
    width: 100%;
  }
