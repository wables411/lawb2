import{ba as w,bi as g,bs as h,bb as v,bd as l}from"./index-D9KCE1j5.js";import{n as a,c as x,e as b,o as c}from"./if-defined-DQAiGHWw.js";import{e as m,n as f}from"./ref-CfB208Xa.js";const y=w`
  :host {
    position: relative;
    width: 100%;
...
`;var e=function(s,t,o,r){var p=arguments.length,n=p<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,o):r,u;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(s,t,o,r);else for(var d=s.length-1;d>=0;d--)(u=s[d])&&(n=(p<3?u(n):p>3?u(t,o,n):u(t,o))||n);return p>3&&n&&Object.defineProperty(t,o,n),n};let i=class extends v{constructor(){super(...arguments),this.inputElementRef=m(),this.size="md",this.disabled=!1,this.placeholder="",this.type="text",this.value=""}render(){const t=`wui-padding-right-${this.inputRightPadding}`,r={[`wui-size-${this.size}`]:!0,[t]:!!this.inputRightPadding};return l`${this.templateIcon()}
      <input
