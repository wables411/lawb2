import{a7 as e,a1 as t,ay as i,O as o,a2 as r,U as n,ac as s,aF as a,ad as d,a0 as c,Y as l,Z as u,_ as p,$ as h,Q as m,a8 as g,a3 as f,I as b,K as w,aG as y,a5 as v,E as x,F as $,G as k,H as S,S as R,aH as E,R as A}from"./index-Bi_hX7G7.js";import{E as C}from"./WalletConnectConnector-D_dvRy3A.js";import"./wagmi-vendor-BoUOF4ar.js";import"./react-vendor-BlDtUSDV.js";import"./chess-vendor-BKDUb1NN.js";import"./ui-vendor-RPKswk1o.js";const T=e`
  div {
    width: 100%;
  }
...
`;var z=function(e,t,i,o){var r,n=arguments.length,s=n<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,o);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(n<3?r(s):n>3?r(t,i,s):r(t,i))||s);return n>3&&s&&Object.defineProperty(t,i,s),s};const j={sm:"md-regular",md:"lg-regular",lg:"lg-regular"},D={success:"sealCheck",error:"warning",warning:"exclamationCircle"};let P=class extends t{constructor(){super(...arguments),this.type="success",this.size="md",this.imageSrc=void 0,this.disabled=!1,this.href="",this.text=void 0}render(){return r`
      <a
        rel="noreferrer"
        target="_blank"
        href=${this.href}
    ...
    `}imageTemplate(){return this.imageSrc?r`<wui-image src=${this.imageSrc} size="inherit"></wui-image>`:r`<wui-icon
      ...
      size="inherit"
      class="image-icon"
    ></wui-icon>`}};P.styles=[u,p,I],z([h()],P.prototype,"type",void 0),z([h()],P.prototype,"size",void 0),z([h()],P.prototype,"imageSrc",void 0),z([h({type:Boolean})],P.prototype,"disabled",void 0),z([h()],P.prototype,"href",void 0),z([h()],P.prototype,"text",void 0),P=z([c("wui-semantic-chip")],P);let _=class extends t{render(){return r`
...
`;var K=function(e,t,i,o){var r,n=arguments.length,s=n<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,o);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(n<3?r(s):n>3?r(t,i,s):r(t,i))||s);return n>3&&s&&Object.defineProperty(t,i,s),s};let Y=class extends t{constructor(){super(...arguments),this.disabled=!1,this.loading=!1}render(){return r`
      ...
      ></wui-input-text>
    `}};Y.styles=[u,F],K([h()],Y.prototype,"errorMessage",void 0),K([h({type:Boolean})],Y.prototype,"disabled",void 0),K([h()],Y.prototype,"value",void 0),K([h({type:Boolean})],Y.prototype,"loading",void 0),K([h({attribute:!1})],Y.prototype,"onKeyDown",void 0),Y=K([c("wui-ens-input")],Y);const H=l`
  wui-flex {
    width: 100%;
  }
...
`;var W=function(e,t,i,o){var r,n=arguments.length,s=n<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,o);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(n<3?r(s):n>3?r(t,i,s):r(t,i))||s);return n>3&&s&&Object.defineProperty(t,i,s),s};let L=class extends t{constructor(){var e;super(),this.formRef=f(),this.usubscribe=[],this.name="",this.error="",this.loading=C.state.loading,this.suggestions=C.state.suggestions,this.profileName=null==(e=b.getAccountData())?void 0:e.profileName,this.onDebouncedNameInputChange=w.debounce(e=>{e.length<4?this.error="Name must be at least 4 characters long":y.isValidReownName(e)?(this.error="",C.getSuggestions(e)):this.error="The value is not a valid username"}),this.usubscribe.push(C.subscribe(e=>{this.suggestions=e.suggestions,this.loading=e.loading}),b.subscribeChainProp("accountState",e=>{this.profileName=null==e?void 0:e.profileName,(null==e?void 0:e.profileName)&&(this.error="You already own a name")}))}firstUpdated(){var e;null==(e=this.formRef.value)||e.addEventListener("keydown",this.onEnterKey.bind(this))}disconnectedCallback(){var e;super.disconnectedCallback(),this.usubscribe.forEach(e=>e()),null==(e=this.formRef.value)||e.removeEventListener("keydown",this.onEnterKey.bind(this))}render(){return r`
      <wui-flex
    ...
    `}submitButtonTemplate(){const e=this.suggestions.find(e=>{var t,i;return(null==(i=null==(t=e.name)?void 0:t.split("."))?void 0:i[0])===this.name&&e.registered});if(this.loading)return r`<wui-loading-spinner
        ...
        color="secondary"
      ></wui-loading-spinner>`;const t=`${this.name}${x.WC_NAME_SUFFIX}`;return r`
      <wui-icon-link
        ?disabled=${Boolean(e)}
    ...
    `}onNameInputChange(e){const t=y.validateReownName(e.detail||"");this.name=t,this.onDebouncedNameInputChange(t)}onKeyDown(e){1!==e.key.length||y.isValidReownName(e.key)||e.preventDefault()}templateSuggestions(){return!this.name||this.name.length<4||this.error?null:r`<wui-flex flexDirection="column" gap="1" alignItems="center">
    ...
    </wui-flex>`}isAllowedToSubmit(e){var t;const i=null==(t=e.split("."))?void 0:t[0],o=this.suggestions.find(e=>{var t,o;return(null==(o=null==(t=e.name)?void 0:t.split("."))?void 0:o[0])===i&&e.registered});return!this.loading&&!this.error&&!this.profileName&&i&&C.validateName(i)&&!o}async onSubmitName(e){try{if(!this.isAllowedToSubmit(e))return;$.sendEvent({type:"track",event:"REGISTER_NAME_INITIATED",properties:{isSmartAccount:k(b.state.activeChain)===S.ACCOUNT_TYPES.SMART_ACCOUNT,ensName:e}}),await C.registerName(e),$.sendEvent({type:"track",event:"REGISTER_NAME_SUCCESS",properties:{isSmartAccount:k(b.state.activeChain)===S.ACCOUNT_TYPES.SMART_ACCOUNT,ensName:e}})}catch(t){R.showError(t.message),$.sendEvent({type:"track",event:"REGISTER_NAME_ERROR",properties:{isSmartAccount:k(b.state.activeChain)===S.ACCOUNT_TYPES.SMART_ACCOUNT,ensName:e,error:w.parseError(t)}})}}onEnterKey(e){if("Enter"===e.key&&this.name&&this.isAllowedToSubmit(this.name)){const e=`${this.name}${x.WC_NAME_SUFFIX}`;this.onSubmitName(e)}}};L.styles=H,W([h()],L.prototype,"errorMessage",void 0),W([d()],L.prototype,"name",void 0),W([d()],L.prototype,"error",void 0),W([d()],L.prototype,"loading",void 0),W([d()],L.prototype,"suggestions",void 0),W([d()],L.prototype,"profileName",void 0),L=W([c("w3m-register-account-name-view")],L);const V=e`
...
`;let G=class extends t{render(){return r`
      ...
      >
        ...
        <wui-link
          @click=${()=>{w.openHref(E.URLS.FAQ,"_blank")}}
        >
          Learn more
