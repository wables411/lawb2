import{Y as e,Z as t,_ as i,$ as n,a0 as a,a1 as o,a2 as s,a8 as r,I as c,at as u,R as l,ab as d,S as h,D as m,ad as p,K as g}from"./index-Bi_hX7G7.js";import"./index-Bkh9COk3.js";import"./wagmi-vendor-BoUOF4ar.js";import"./react-vendor-BlDtUSDV.js";import"./chess-vendor-BKDUb1NN.js";import"./ui-vendor-RPKswk1o.js";const w=e`
  button {
    border: none;
...
`;var D=function(e,t,i,n){var a,o=arguments.length,s=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,n);else for(var r=e.length-1;r>=0;r--)(a=e[r])&&(s=(o<3?a(s):o>3?a(t,i,s):a(t,i))||s);return o>3&&s&&Object.defineProperty(t,i,s),s};let C=class extends o{constructor(){super(),this.unsubscribe=[],this.assets=u.state.assets,this.search="",this.onDebouncedSearch=g.debounce(e=>{this.search=e}),this.unsubscribe.push(u.subscribe(e=>{this.assets=e.assets}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return s`
    ...
    `}onBuyClick(){l.push("OnRampProviders")}onInputChange(e){this.onDebouncedSearch(e.detail)}handleTokenClick(e){u.setPaymentAsset(e),l.goBack()}};C.styles=A,D([p()],C.prototype,"assets",void 0),D([p()],C.prototype,"search",void 0),C=D([a("w3m-deposit-from-exchange-select-asset-view")],C);export{C as W3mDepositFromExchangeSelectAssetView,P as W3mDepositFromExchangeView};
