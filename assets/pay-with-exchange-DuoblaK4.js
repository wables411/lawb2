import{c as e,r as t,e as i,n,b as o,i as a,x as s,L as r,l as c,P as u,R as l,K as d,S as h,C as m,M as p,o as g}from"./index-BnysZL_a.js";import"./index-Bw1Z-RAh.js";import"./wagmi-vendor-CHW5eFys.js";import"./react-vendor-ZyuiJZO_.js";import"./chess-vendor-JTxzwGi1.js";import"./ui-vendor-BgPmeekb.js";const w=e`
  button {
    border: none;
...
`;var x=function(e,t,i,n){var o,a=arguments.length,s=a<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,n);else for(var r=e.length-1;r>=0;r--)(o=e[r])&&(s=(a<3?o(s):a>3?o(t,i,s):o(t,i))||s);return a>3&&s&&Object.defineProperty(t,i,s),s};const y={sm:"sm-regular",md:"md-regular",lg:"lg-regular"};let f=class extends a{constructor(){super(...arguments),this.type="accent",this.size="md",this.imageSrc="",this.disabled=!1,this.leftIcon=void 0,this.rightIcon=void 0,this.text=""}render(){return s`
    ...
    `}};f.styles=[t,i,w],x([n()],f.prototype,"type",void 0),x([n()],f.prototype,"size",void 0),x([n()],f.prototype,"imageSrc",void 0),x([n({type:Boolean})],f.prototype,"disabled",void 0),x([n()],f.prototype,"leftIcon",void 0),x([n()],f.prototype,"rightIcon",void 0),x([n()],f.prototype,"text",void 0),f=x([o("wui-chip-button")],f);var b=function(e,t,i,n){var o,a=arguments.length,s=a<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,n);else for(var r=e.length-1;r>=0;r--)(o=e[r])&&(s=(a<3?o(s):a>3?o(t,i,s):o(t,i))||s);return a>3&&s&&Object.defineProperty(t,i,s),s};let v=class extends a{constructor(){super(...arguments),this.maxDecimals=void 0,this.maxIntegers=void 0}render(){return s`
...
`;var C=function(e,t,i,n){var o,a=arguments.length,s=a<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,n);else for(var r=e.length-1;r>=0;r--)(o=e[r])&&(s=(a<3?o(s):a>3?o(t,i,s):o(t,i))||s);return a>3&&s&&Object.defineProperty(t,i,s),s};let D=class extends a{constructor(){super(),this.unsubscribe=[],this.assets=u.state.assets,this.search="",this.onDebouncedSearch=g.debounce(e=>{this.search=e}),this.unsubscribe.push(u.subscribe(e=>{this.assets=e.assets}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return s`
    ...
    `}onBuyClick(){l.push("OnRampProviders")}onInputChange(e){this.onDebouncedSearch(e.detail)}handleTokenClick(e){u.setPaymentAsset(e),l.goBack()}};D.styles=A,C([p()],D.prototype,"assets",void 0),C([p()],D.prototype,"search",void 0),D=C([o("w3m-deposit-from-exchange-select-asset-view")],D);export{D as W3mDepositFromExchangeSelectAssetView,P as W3mDepositFromExchangeView};
