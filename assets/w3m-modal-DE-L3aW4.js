import{F as e,H as t,I as i,G as o,K as a,J as r}from"./index-FICmtEPc.js";import{w as s,p as n,s as c,l,M as w,m as d,R as p,r as u,n as m,e as h,k as v,g,c as f,h as b,o as y,E as x,O as k,C,q as S,i as R,A as N,T as O,t as T,a as A,f as W}from"./core-DVil2PsT.js";import{c as $,U as E}from"./index-C3IJ9xZW.js";import"./wagmi-vendor-Bzrt1iI4.js";import"./react-vendor-CFG7hIzY.js";import"./chess-vendor-Bf0-dA_p.js";import"./ui-vendor-mkN-aWYF.js";import"./index.es-B9abEWOe.js";import"./index-CFYEtFbK.js";const I=n({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),P=s({state:I,subscribe:e=>l(I,()=>e(I)),subscribeKey:(e,t)=>c(I,e,t),showTooltip({message:e,triggerRect:t,variant:i}){I.open=!0,I.message=e,I.triggerRect=t,I.variant=i},hide(){I.open=!1,I.message="",I.triggerRect={width:0,height:0,top:0,left:0}}}),j={isUnsupportedChainView:()=>"UnsupportedChain"===p.state.view||"SwitchNetwork"===p.state.view&&p.state.history.includes("UnsupportedChain"),async safeClose(){if(this.isUnsupportedChainView())return void w.shake();await d.isSIWXCloseDisabled()?w.shake():w.close()}},D=e`
  :host {
    display: block;
...
`;var q=function(e,t,i,o){var a,r=arguments.length,s=r<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,o);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(s=(r<3?a(s):r>3?a(t,i,s):a(t,i))||s);return r>3&&s&&Object.defineProperty(t,i,s),s};let F=class extends t{constructor(){super(...arguments),this.imageSrc=""}render(){return i`<button>
    ...
    ></wui-icon-box>`}};F.styles=[u,h,v,G],q([o()],F.prototype,"imageSrc",void 0),F=q([$("wui-select")],F);const J=e`
  :host {
    height: 64px;
  }
