import{i as e,d as t,al as i,am as r,aa as o,V as s,M as n,x as a,a4 as c,O as l,c as u,n as d,j as p,L as h,E as m,h as w,W as g,R as y,k as v,C as f,T as b,S as x,s as C}from"./index-Cw8fKJ5f.js";import"./wagmi-vendor-B_qL9Hk_.js";import"./react-vendor-ZyuiJZO_.js";import"./chess-vendor-JTxzwGi1.js";import"./ui-vendor-BgPmeekb.js";const k=e`
  :host > wui-grid {
    max-height: 360px;
    overflow: auto;
  }
...
`;var $=function(e,t,i,r){var o,s=arguments.length,n=s<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,i,r);else for(var a=e.length-1;a>=0;a--)(o=e[a])&&(n=(s<3?o(n):s>3?o(t,i,n):o(t,i))||n);return s>3&&n&&Object.defineProperty(t,i,n),n};let R=class extends t{constructor(){super(),this.unsubscribe=[],this.selectedCurrency=i.state.paymentCurrency,this.currencies=i.state.paymentCurrencies,this.currencyImages=r.state.currencyImages,this.checked=o.state.isLegalCheckboxChecked,this.unsubscribe.push(i.subscribe(e=>{this.selectedCurrency=e.paymentCurrency,this.currencies=e.paymentCurrencies}),r.subscribeKey("currencyImages",e=>this.currencyImages=e),o.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var e;const{termsConditionsUrl:t,privacyPolicyUrl:i}=s.state,r=null==(e=s.state.features)?void 0:e.legalCheckbox,o=Boolean(t||i)&&Boolean(r)&&!this.checked;return a`
    ...
    `}currenciesTemplate(e=!1){return this.currencies.map(t=>{var i;return a`
        <wui-list-item
          imageSrc=${n(null==(i=this.currencyImages)?void 0:i[t.id])}
...
`;var I=function(e,t,i,r){var o,s=arguments.length,n=s<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,i,r);else for(var a=e.length-1;a>=0;a--)(o=e[a])&&(n=(s<3?o(n):s>3?o(t,i,n):o(t,i))||n);return s>3&&n&&Object.defineProperty(t,i,n),n};let O=class extends t{constructor(){super(...arguments),this.disabled=!1,this.color="inherit",this.label="",this.feeRange="",this.loading=!1,this.onClick=null}render(){return a`
    ...
    `}networksTemplate(){var e;const t=p.getAllRequestedCaipNetworks(),i=null==(e=null==t?void 0:t.filter(e=>{var t;return null==(t=null==e?void 0:e.assets)?void 0:t.imageId}))?void 0:e.slice(0,5);return a`
      <wui-flex class="networks">
        ${null==i?void 0:i.map(e=>a`
...
`;let j=class extends t{render(){const{termsConditionsUrl:e,privacyPolicyUrl:t}=s.state;return e||t?a`
      <wui-flex
        .padding=${["m","s","s","s"]}
        flexDirection="column"
        alignItems="center"
...
`;var E=function(e,t,i,r){var o,s=arguments.length,n=s<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,i,r);else for(var a=e.length-1;a>=0;a--)(o=e[a])&&(n=(s<3?o(n):s>3?o(t,i,n):o(t,i))||n);return s>3&&n&&Object.defineProperty(t,i,n),n};let S=class extends t{constructor(){super(),this.unsubscribe=[],this.selectedCurrency=i.state.purchaseCurrencies,this.tokens=i.state.purchaseCurrencies,this.tokenImages=r.state.tokenImages,this.checked=o.state.isLegalCheckboxChecked,this.unsubscribe.push(i.subscribe(e=>{this.selectedCurrency=e.purchaseCurrencies,this.tokens=e.purchaseCurrencies}),r.subscribeKey("tokenImages",e=>this.tokenImages=e),o.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var e;const{termsConditionsUrl:t,privacyPolicyUrl:i}=s.state,r=null==(e=s.state.features)?void 0:e.legalCheckbox,o=Boolean(t||i)&&Boolean(r)&&!this.checked;return a`
      <w3m-legal-checkbox></w3m-legal-checkbox>
      <wui-flex
        flexDirection="column"
        .padding=${["0","s","s","s"]}
      ...
      <w3m-legal-footer></w3m-legal-footer>
    `}currenciesTemplate(e=!1){return this.tokens.map(t=>{var i;return a`
        <wui-list-item
          imageSrc=${n(null==(i=this.tokenImages)?void 0:i[t.symbol])}
...
`;var L=function(e,t,i,r){var o,s=arguments.length,n=s<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,i,r);else for(var a=e.length-1;a>=0;a--)(o=e[a])&&(n=(s<3?o(n):s>3?o(t,i,n):o(t,i))||n);return s>3&&n&&Object.defineProperty(t,i,n),n};let z=class extends t{constructor(){super(),this.unsubscribe=[],this.selectedOnRampProvider=i.state.selectedProvider,this.uri=f.state.wcUri,this.ready=!1,this.showRetry=!1,this.buffering=!1,this.error=!1,this.isMobile=!1,this.onRetry=void 0,this.unsubscribe.push(i.subscribeKey("selectedProvider",e=>{this.selectedOnRampProvider=e}))}disconnectedCallback(){this.intervalId&&clearInterval(this.intervalId)}render(){var e,t;let i="Continue in external window";this.error?i="Buy failed":this.selectedOnRampProvider&&(i=`Buy in ${null==(e=this.selectedOnRampProvider)?void 0:e.label}`);const r=this.error?"Buy can be declined from your side or due to and error on the provider app":"We’ll notify you once your Buy is processed";return a`
      <wui-flex
    ...
    `}onTryAgain(){this.selectedOnRampProvider&&(this.error=!1,v.openHref(this.selectedOnRampProvider.url,"popupWindow","width=600,height=800,scrollbars=yes"))}tryAgainTemplate(){var e;return(null==(e=this.selectedOnRampProvider)?void 0:e.url)?a`<wui-button size="md" variant="accent" @click=${this.onTryAgain.bind(this)}>
      ...
      Try again
    </wui-button>`:null}loaderTemplate(){const e=b.state.themeVariables["--w3m-border-radius-master"],t=e?parseInt(e.replace("px",""),10):4;return a`<wui-loading-thumbnail radius=${9*t}></wui-loading-thumbnail>`}onCopyUri(){var e;if(!(null==(e=this.selectedOnRampProvider)?void 0:e.url))return x.showError("No link found"),void y.goBack();try{v.copyToClopboard(this.selectedOnRampProvider.url),x.showSuccess("Link copied")}catch{x.showError("Failed to copy")}}};z.styles=U,L([l()],z.prototype,"intervalId",void 0),L([l()],z.prototype,"selectedOnRampProvider",void 0),L([l()],z.prototype,"uri",void 0),L([l()],z.prototype,"ready",void 0),L([l()],z.prototype,"showRetry",void 0),L([l()],z.prototype,"buffering",void 0),L([l()],z.prototype,"error",void 0),L([d({type:Boolean})],z.prototype,"isMobile",void 0),L([d()],z.prototype,"onRetry",void 0),z=L([u("w3m-buy-in-progress-view")],z);let F=class extends t{render(){return a`
      <wui-flex
        flexDirection="column"
    ...
    `}onrampTemplate(){var e;if(!this.namespace)return null;const t=null==(e=this.remoteFeatures)?void 0:e.onramp,i=C.ONRAMP_SUPPORTED_CHAIN_NAMESPACES.includes(this.namespace);return t&&i?a`
      ...
      ></wui-list-description>
    `:null}depositFromExchangeTemplate(){var e;return(null==(e=this.remoteFeatures)?void 0:e.payWithExchange)?a`
      <wui-list-description
      ...
      ></wui-list-description>
    `:null}receiveTemplate(){var e;return Boolean(null==(e=this.features)?void 0:e.receive)?a`
      <wui-list-description
      ...
      <wui-flex flexDirection="column" justifyContent="center" alignItems="center">
        <wui-flex flexDirection="column" alignItems="center" gap="xs">
          ...
          <wui-flex justifyContent="space-evenly" class="amounts-container" gap="xs">
            ${Q.map(e=>{var t;return a`<wui-button
