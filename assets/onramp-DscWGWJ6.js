import{X as e,a0 as t,am as r,aE as i,aj as o,a7 as n,a1 as s,az as a,ad as c,$ as u,_ as l,I as d,ab as p,R as m,K as h,G as y,H as g,W as w,E as f,ac as b,S as v}from"./index-D1A2MkxD.js";import{O as x}from"./react-D_laG3hB.js";import"./wagmi-vendor-DNR7MlZp.js";import"./react-vendor-BlDtUSDV.js";import"./chess-vendor-BKDUb1NN.js";import"./ui-vendor-DXGEkimk.js";import"./index-2zADm1el.js";import"./index-CFYEtFbK.js";import"./WalletConnectConnector-CWWdg90A.js";const $=e`
  :host > wui-grid {
    max-height: 360px;
    overflow: auto;
  }
...
`;var P=function(e,t,r,i){var o,n=arguments.length,s=n<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,r):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,r,i);else for(var a=e.length-1;a>=0;a--)(o=e[a])&&(s=(n<3?o(s):n>3?o(t,r,s):o(t,r))||s);return n>3&&s&&Object.defineProperty(t,r,s),s};let I=class extends t{constructor(){super(...arguments),this.disabled=!1,this.color="inherit",this.label="",this.feeRange="",this.loading=!1,this.onClick=null}render(){return s`
    ...
    `}};I.styles=[R],P([l({type:Boolean})],I.prototype,"disabled",void 0),P([l()],I.prototype,"color",void 0),P([l()],I.prototype,"name",void 0),P([l()],I.prototype,"label",void 0),P([l()],I.prototype,"feeRange",void 0),P([l({type:Boolean})],I.prototype,"loading",void 0),P([l()],I.prototype,"onClick",void 0),I=P([u("w3m-onramp-provider-item")],I);var j=function(e,t,r,i){var o,n=arguments.length,s=n<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,r):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,r,i);else for(var a=e.length-1;a>=0;a--)(o=e[a])&&(s=(n<3?o(s):n>3?o(t,r,s):o(t,r))||s);return n>3&&s&&Object.defineProperty(t,r,s),s};let O=class extends t{constructor(){super(),this.unsubscribe=[],this.providers=x.state.providers,this.unsubscribe.push(x.subscribeKey("providers",e=>{this.providers=e}))}render(){return s`
...
`;var T=function(e,t,r,i){var o,n=arguments.length,s=n<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,r):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,r,i);else for(var a=e.length-1;a>=0;a--)(o=e[a])&&(s=(n<3?o(s):n>3?o(t,r,s):o(t,r))||s);return n>3&&s&&Object.defineProperty(t,r,s),s};let B=class extends t{constructor(){super(),this.unsubscribe=[],this.selectedCurrency=x.state.purchaseCurrencies,this.tokens=x.state.purchaseCurrencies,this.tokenImages=r.state.tokenImages,this.checked=i.state.isLegalCheckboxChecked,this.unsubscribe.push(x.subscribe(e=>{this.selectedCurrency=e.purchaseCurrencies,this.tokens=e.purchaseCurrencies}),r.subscribeKey("tokenImages",e=>this.tokenImages=e),i.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var e;const{termsConditionsUrl:t,privacyPolicyUrl:r}=o.state,i=null==(e=o.state.features)?void 0:e.legalCheckbox,a=Boolean(t||r)&&Boolean(i)&&!this.checked;return s`
      <w3m-legal-checkbox></w3m-legal-checkbox>
      <wui-flex
        flexDirection="column"
        .padding=${["0","3","3","3"]}
    ...
    `}currenciesTemplate(e=!1){return this.tokens.map(t=>{var r;return s`
      ...
      `})}selectToken(e){e&&(x.setPurchaseCurrency(e),a.close())}};B.styles=A,T([c()],B.prototype,"selectedCurrency",void 0),T([c()],B.prototype,"tokens",void 0),T([c()],B.prototype,"tokenImages",void 0),T([c()],B.prototype,"checked",void 0),B=T([u("w3m-onramp-token-select-view")],B);const D=e`
  @keyframes shake {
    0% {
...
`;var L=function(e,t,r,i){var o,n=arguments.length,s=n<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,r):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,r,i);else for(var a=e.length-1;a>=0;a--)(o=e[a])&&(s=(n<3?o(s):n>3?o(t,r,s):o(t,r))||s);return n>3&&s&&Object.defineProperty(t,r,s),s};let z=class extends t{constructor(){super(),this.unsubscribe=[],this.selectedOnRampProvider=x.state.selectedProvider,this.uri=f.state.wcUri,this.ready=!1,this.showRetry=!1,this.buffering=!1,this.error=!1,this.isMobile=!1,this.onRetry=void 0,this.unsubscribe.push(x.subscribeKey("selectedProvider",e=>{this.selectedOnRampProvider=e}))}disconnectedCallback(){this.intervalId&&clearInterval(this.intervalId)}render(){var e,t;let r="Continue in external window";this.error?r="Buy failed":this.selectedOnRampProvider&&(r=`Buy in ${null==(e=this.selectedOnRampProvider)?void 0:e.label}`);const i=this.error?"Buy can be declined from your side or due to and error on the provider app":"We’ll notify you once your Buy is processed";return s`
      <wui-flex
    ...
    `}onTryAgain(){this.selectedOnRampProvider&&(this.error=!1,h.openHref(this.selectedOnRampProvider.url,"popupWindow","width=600,height=800,scrollbars=yes"))}tryAgainTemplate(){var e;return(null==(e=this.selectedOnRampProvider)?void 0:e.url)?s`<wui-button size="md" variant="accent" @click=${this.onTryAgain.bind(this)}>
      ...
      Try again
    </wui-button>`:null}loaderTemplate(){const e=b.state.themeVariables["--w3m-border-radius-master"],t=e?parseInt(e.replace("px",""),10):4;return s`<wui-loading-thumbnail radius=${9*t}></wui-loading-thumbnail>`}onCopyUri(){var e;if(!(null==(e=this.selectedOnRampProvider)?void 0:e.url))return v.showError("No link found"),void m.goBack();try{h.copyToClopboard(this.selectedOnRampProvider.url),v.showSuccess("Link copied")}catch{v.showError("Failed to copy")}}};z.styles=D,L([c()],z.prototype,"intervalId",void 0),L([c()],z.prototype,"selectedOnRampProvider",void 0),L([c()],z.prototype,"uri",void 0),L([c()],z.prototype,"ready",void 0),L([c()],z.prototype,"showRetry",void 0),L([c()],z.prototype,"buffering",void 0),L([c()],z.prototype,"error",void 0),L([l({type:Boolean})],z.prototype,"isMobile",void 0),L([l()],z.prototype,"onRetry",void 0),z=L([u("w3m-buy-in-progress-view")],z);let E=class extends t{render(){return s`
      <wui-flex
        flexDirection="column"
        .padding=${["6","10","5","10"]}
        alignItems="center"
    ...
    `}};E=function(e,t,r,i){var o,n=arguments.length,s=n<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,r):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,r,i);else for(var a=e.length-1;a>=0;a--)(o=e[a])&&(s=(n<3?o(s):n>3?o(t,r,s):o(t,r))||s);return n>3&&s&&Object.defineProperty(t,r,s),s}([u("w3m-what-is-a-buy-view")],E);const S=e`
  :host {
    width: 100%;
  }
...
`;var U=function(e,t,r,i){var o,n=arguments.length,s=n<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,r):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,r,i);else for(var a=e.length-1;a>=0;a--)(o=e[a])&&(s=(n<3?o(s):n>3?o(t,r,s):o(t,r))||s);return n>3&&s&&Object.defineProperty(t,r,s),s};let K=class extends t{constructor(){var e;super(),this.unsubscribe=[],this.type="Token",this.value=0,this.currencies=[],this.selectedCurrency=null==(e=this.currencies)?void 0:e[0],this.currencyImages=r.state.currencyImages,this.tokenImages=r.state.tokenImages,this.unsubscribe.push(x.subscribeKey("purchaseCurrency",e=>{e&&"Fiat"!==this.type&&(this.selectedCurrency=this.formatPurchaseCurrency(e))}),x.subscribeKey("paymentCurrency",e=>{e&&"Token"!==this.type&&(this.selectedCurrency=this.formatPaymentCurrency(e))}),x.subscribe(e=>{"Fiat"===this.type?this.currencies=e.purchaseCurrencies.map(this.formatPurchaseCurrency):this.currencies=e.paymentCurrencies.map(this.formatPaymentCurrency)}),r.subscribe(e=>{this.currencyImages={...e.currencyImages},this.tokenImages={...e.tokenImages}}))}firstUpdated(){x.getAvailableCurrencies()}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var e;const t=(null==(e=this.selectedCurrency)?void 0:e.symbol)||"",r=this.currencyImages[t]||this.tokenImages[t];return s`<wui-input-text type="number" size="lg" value=${this.value}>
    ...
    </wui-input-text>`}formatPaymentCurrency(e){return{name:e.id,symbol:e.id}}formatPurchaseCurrency(e){return{name:e.name,symbol:e.symbol}}};K.styles=S,U([l({type:String})],K.prototype,"type",void 0),U([l({type:Number})],K.prototype,"value",void 0),U([c()],K.prototype,"currencies",void 0),U([c()],K.prototype,"selectedCurrency",void 0),U([c()],K.prototype,"currencyImages",void 0),U([c()],K.prototype,"tokenImages",void 0),K=U([u("w3m-onramp-input")],K);const q=e`
  :host > wui-flex {
    width: 100%;
    max-width: 360px;
  }
