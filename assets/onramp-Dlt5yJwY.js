import{i as e,c as t,ai as r,aj as i,$ as o,Y as s,J as n,x as a,a3 as c,K as l,d as u,H as d,n as p,I as h,E as w,l as m,W as g,R as y,o as v,C as f,T as b,S as x}from"./index-CefgnnXl.js";import"./wagmi-vendor-Dfx1X9pT.js";import"./react-vendor-ZyuiJZO_.js";import"./chess-vendor-JTxzwGi1.js";import"./ui-vendor-BgPmeekb.js";const k=e`
  :host > wui-grid {
    max-height: 360px;
    overflow: auto;
  }
...
`;var N=function(e,t,r,i){var o,s=arguments.length,n=s<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,r):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,r,i);else for(var a=e.length-1;a>=0;a--)(o=e[a])&&(n=(s<3?o(n):s>3?o(t,r,n):o(t,r))||n);return s>3&&n&&Object.defineProperty(t,r,n),n};const M={USD:"$",EUR:"€",GBP:"£"},Y=[100,250,500,1e3];let F=class extends t{constructor(){super(),this.unsubscribe=[],this.disabled=!1,this.caipAddress=p.state.activeCaipAddress,this.loading=c.state.loading,this.paymentCurrency=r.state.paymentCurrency,this.paymentAmount=r.state.paymentAmount,this.purchaseAmount=r.state.purchaseAmount,this.quoteLoading=r.state.quotesLoading,this.unsubscribe.push(p.subscribeKey("activeCaipAddress",e=>this.caipAddress=e),c.subscribeKey("loading",e=>{this.loading=e}),r.subscribe(e=>{this.paymentCurrency=e.paymentCurrency,this.paymentAmount=e.paymentAmount,this.purchaseAmount=e.purchaseAmount,this.quoteLoading=e.quotesLoading}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return a`
      <wui-flex flexDirection="column" justifyContent="center" alignItems="center">
        <wui-flex flexDirection="column" alignItems="center" gap="xs">
          ...
          <wui-flex justifyContent="space-evenly" class="amounts-container" gap="xs">
            ${Y.map(e=>{var t;return a`<wui-button
    ...
    `}templateButton(){return this.caipAddress?a`<wui-button
        ...
        >
          Connect wallet
        </wui-button>`}getQuotes(){this.loading||c.open({view:"OnRampProviders"})}openModal(){c.open({view:"Connect"})}async onPaymentAmountChange(e){r.setPaymentAmount(Number(e.detail)),await r.getQuote()}async selectPresetAmount(e){r.setPaymentAmount(e),await r.getQuote()}};F.styles=q,N([d({type:Boolean})],F.prototype,"disabled",void 0),N([l()],F.prototype,"caipAddress",void 0),N([l()],F.prototype,"loading",void 0),N([l()],F.prototype,"paymentCurrency",void 0),N([l()],F.prototype,"paymentAmount",void 0),N([l()],F.prototype,"purchaseAmount",void 0),N([l()],F.prototype,"quoteLoading",void 0),F=N([u("w3m-onramp-widget")],F);export{z as W3mBuyInProgressView,T as W3mOnRampProvidersView,$ as W3mOnrampFiatSelectView,U as W3mOnrampTokensView,F as W3mOnrampWidget,E as W3mWhatIsABuyView};
