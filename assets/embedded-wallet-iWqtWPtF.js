import{u as e,k as t,a7 as i,a3 as o,x as r,L as n,$ as s,aj as a,a0 as d,j as l,f as c,h as u,i as p,n as h,J as m,P as g,s as f,ak as b,B as w,F as y,al as v,t as x,z as $,E as k,A as S,W as R,S as E,am as A,R as C}from"./index-CVeJVV4C.js";import"./wagmi-vendor-DI5-0FB7.js";import"./react-vendor-ZyuiJZO_.js";import"./chess-vendor-JTxzwGi1.js";import"./ui-vendor-BgPmeekb.js";const T=e`
  div {
    width: 100%;
  }
...
`;var j=function(e,t,i,o){var r,n=arguments.length,s=n<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,o);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(n<3?r(s):n>3?r(t,i,s):r(t,i))||s);return n>3&&s&&Object.defineProperty(t,i,s),s};const I={sm:"md-regular",md:"lg-regular",lg:"lg-regular"},P={success:"sealCheck",error:"warning",warning:"exclamationCircle"};let D=class extends t{constructor(){super(...arguments),this.type="success",this.size="md",this.imageSrc=void 0,this.disabled=!1,this.href="",this.text=void 0}render(){return r`
      <a
        rel="noreferrer"
        target="_blank"
        href=${this.href}
      ...
      >
        ${this.imageTemplate()}
        <wui-text variant=${I[this.size]} color="inherit">${this.text}</wui-text>
      </a>
    `}imageTemplate(){return this.imageSrc?r`<wui-image src=${this.imageSrc} size="inherit"></wui-image>`:r`<wui-icon
      ...
      size="inherit"
      class="image-icon"
    ></wui-icon>`}};D.styles=[u,p,z],j([h()],D.prototype,"type",void 0),j([h()],D.prototype,"size",void 0),j([h()],D.prototype,"imageSrc",void 0),j([h({type:Boolean})],D.prototype,"disabled",void 0),j([h()],D.prototype,"href",void 0),j([h()],D.prototype,"text",void 0),D=j([l("wui-semantic-chip")],D);let _=class extends t{render(){return r`
