import{i as t,j as e,k as i,n,s as o,t as s,x as r,z as a,a3 as l,U as u,a4 as p,R as c,P as h,I as d,S as m}from"./index-BU7BHFTH.js";const g=t`
  :host {
    position: relative;
...
`;var I,$=function(t,e,i,n){var o,s=arguments.length,r=s<3?e:null===n?n=Object.getOwnPropertyDescriptor(e,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,i,n);else for(var a=t.length-1;a>=0;a--)(o=t[a])&&(r=(s<3?o(r):s>3?o(e,i,r):o(e,i))||r);return s>3&&r&&Object.defineProperty(e,i,r),r};let T=I=class extends s{firstUpdated(){this.startOTPTimeout()}disconnectedCallback(){clearTimeout(this.OTPTimeout)}constructor(){var t;super(),this.loading=!1,this.timeoutTimeLeft=p.getTimeToNextEmailLogin(),this.error="",this.otp="",this.email=null==(t=c.state.data)?void 0:t.email,this.authConnector=h.getAuthConnector()}render(){if(!this.email)throw new Error("w3m-email-otp-widget: No email provided");const t=Boolean(this.timeoutTimeLeft),e=this.getFooterLabels(t);return r`
      <wui-flex
