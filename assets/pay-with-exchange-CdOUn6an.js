import{c as e,r as t,e as i,n,a,i as o,x as s,o as r,E as c,g as u}from"./react-CJFWHICN.js";import"./index-rChLghRT.js";import{a as l,R as d,j as h,S as m,C as p,b as g}from"./W3MFrameProviderSingleton-CzpTE7Ae.js";import"./react-vendor-BlDtUSDV.js";import"./NetworkUtil-8PBlJxlj.js";import"./wagmi-vendor-BS3qzBkV.js";import"./index-CFYEtFbK.js";const w=e`
  button {
    border: none;
...
`;var k=function(e,t,i,n){var a,o=arguments.length,s=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,n);else for(var r=e.length-1;r>=0;r--)(a=e[r])&&(s=(o<3?a(s):o>3?a(t,i,s):a(t,i))||s);return o>3&&s&&Object.defineProperty(t,i,s),s};const I=[10,50,100];let P=class extends o{constructor(){super(),this.unsubscribe=[],this.network=l.state.activeCaipNetwork,this.exchanges=c.state.exchanges,this.isLoading=c.state.isLoading,this.amount=c.state.amount,this.tokenAmount=c.state.tokenAmount,this.priceLoading=c.state.priceLoading,this.isPaymentInProgress=c.state.isPaymentInProgress,this.currentPayment=c.state.currentPayment,this.paymentId=c.state.paymentId,this.paymentAsset=c.state.paymentAsset,this.unsubscribe.push(l.subscribeKey("activeCaipNetwork",e=>{this.network=e,this.setDefaultPaymentAsset()}),c.subscribe(e=>{var t,i;this.exchanges=e.exchanges,this.isLoading=e.isLoading,this.amount=e.amount,this.tokenAmount=e.tokenAmount,this.priceLoading=e.priceLoading,this.paymentId=e.paymentId,this.isPaymentInProgress=e.isPaymentInProgress,this.currentPayment=e.currentPayment,this.paymentAsset=e.paymentAsset;e.isPaymentInProgress&&(null==(t=e.currentPayment)?void 0:t.exchangeId)&&(null==(i=e.currentPayment)?void 0:i.sessionId)&&e.paymentId&&this.handlePaymentInProgress()}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e());c.state.isPaymentInProgress||c.reset()}async firstUpdated(){await this.getPaymentAssets(),this.paymentAsset||await this.setDefaultPaymentAsset(),c.setAmount(I[0]),await c.fetchExchanges()}render(){return s`
      ...
      >
        ...
        >
          ...
          <wui-token-button
            ...
            size="lg"
            .chainImageSrc=${r(h.getNetworkImage(this.network))}
          >
          </wui-token-button>
        </wui-flex>
        <wui-flex
    ...
    `}async onExchangeClick(e){this.amount?await c.handlePayWithExchange(e.id):m.showError("Please enter an amount")}handlePaymentInProgress(){var e,t;const i=l.state.activeChain,{redirectView:n="Account"}=d.state.data??{};this.isPaymentInProgress&&(null==(e=this.currentPayment)?void 0:e.exchangeId)&&(null==(t=this.currentPayment)?void 0:t.sessionId)&&this.paymentId&&(c.waitUntilComplete({exchangeId:this.currentPayment.exchangeId,sessionId:this.currentPayment.sessionId,paymentId:this.paymentId}).then(e=>{"SUCCESS"===e.status?(m.showSuccess("Deposit completed"),c.reset(),i&&(l.fetchTokenBalance(),p.updateBalance(i)),d.replace("Transactions")):"FAILED"===e.status&&m.showError("Deposit failed")}),m.showLoading("Deposit in progress..."),d.replace(n))}onAmountChange({detail:e}){c.setAmount(e?Number(e):null)}async getPaymentAssets(){this.network&&await c.getAssetsForNetwork(this.network.caipNetworkId)}async setDefaultPaymentAsset(){if(this.network){const e=await c.getAssetsForNetwork(this.network.caipNetworkId);e[0]&&c.setPaymentAsset(e[0])}}};P.styles=$,k([u()],P.prototype,"network",void 0),k([u()],P.prototype,"exchanges",void 0),k([u()],P.prototype,"isLoading",void 0),k([u()],P.prototype,"amount",void 0),k([u()],P.prototype,"tokenAmount",void 0),k([u()],P.prototype,"priceLoading",void 0),k([u()],P.prototype,"isPaymentInProgress",void 0),k([u()],P.prototype,"currentPayment",void 0),k([u()],P.prototype,"paymentId",void 0),k([u()],P.prototype,"paymentAsset",void 0),P=k([a("w3m-deposit-from-exchange-view")],P);const A=e`
  .contentContainer {
    height: 440px;
    overflow: scroll;
...
`;var C=function(e,t,i,n){var a,o=arguments.length,s=o<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,n);else for(var r=e.length-1;r>=0;r--)(a=e[r])&&(s=(o<3?a(s):o>3?a(t,i,s):a(t,i))||s);return o>3&&s&&Object.defineProperty(t,i,s),s};let D=class extends o{constructor(){super(),this.unsubscribe=[],this.assets=c.state.assets,this.search="",this.onDebouncedSearch=g.debounce(e=>{this.search=e}),this.unsubscribe.push(c.subscribe(e=>{this.assets=e.assets}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return s`
    ...
    `}onBuyClick(){d.push("OnRampProviders")}onInputChange(e){this.onDebouncedSearch(e.detail)}handleTokenClick(e){c.setPaymentAsset(e),d.goBack()}};D.styles=A,C([u()],D.prototype,"assets",void 0),C([u()],D.prototype,"search",void 0),D=C([a("w3m-deposit-from-exchange-select-asset-view")],D);export{D as W3mDepositFromExchangeSelectAssetView,P as W3mDepositFromExchangeView};
