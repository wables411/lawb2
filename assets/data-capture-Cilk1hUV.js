import{a1 as t,X as i,Y as e,U as a,V as o,ab as n,R as r,z as s,S as l,a5 as c,a0 as u,an as d,ao as p}from"./index-OpbypVz_.js";import{W as h}from"./index-DGpolAkb.js";import{ReownAuthentication as m}from"./features-D93ekYa4.js";import"./wagmi-vendor-Sv5HvNCH.js";import"./ui-vendor-GwtnLNQ7.js";import"./chess-vendor-C25K65co.js";const g=t`
  .email-sufixes {
    display: flex;
    flex-direction: row;
...
`;var S=function(t,i,e,a){var o,n=arguments.length,r=n<3?i:null===a?a=Object.getOwnPropertyDescriptor(i,e):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,i,e,a);else for(var s=t.length-1;s>=0;s--)(o=t[s])&&(r=(n<3?o(r):n>3?o(i,e,r):o(i,e))||r);return n>3&&r&&Object.defineProperty(i,e,r),r};let O=class extends i{constructor(){var t,i,e,a,o,l,c;super(...arguments),this.email=(null==(t=r.state.data)?void 0:t.email)??(null==(e=null==(i=s.getAccountData())?void 0:i.user)?void 0:e.email)??"",this.address=(null==(a=s.getAccountData())?void 0:a.address)??"",this.loading=!1,this.appName=(null==(o=n.state.metadata)?void 0:o.name)??"AppKit",this.siwx=n.state.siwx,this.isRequired=Array.isArray(null==(l=n.state.remoteFeatures)?void 0:l.emailCapture)&&(null==(c=n.state.remoteFeatures)?void 0:c.emailCapture.includes("required")),this.recentEmails=this.getRecentEmails()}connectedCallback(){this.siwx&&this.siwx instanceof m||l.showError("ReownAuthentication is not initialized. Please contact support."),super.connectedCallback()}firstUpdated(){this.loading=!1,this.recentEmails=this.getRecentEmails(),this.email&&this.onSubmit()}render(){return e`
