...
// reef-validator/signerEntry.mjs
var signerEntry_exports = {};
__export(signerEntry_exports, {
...
module.exports = __toCommonJS(signerEntry_exports);
...
function getBaseEncoder(type) {
  {
    ...
    if (match) {
      ...
      const boundsLower = signed ? (boundsUpper + BN_13) * BN__1 : BN_04;
